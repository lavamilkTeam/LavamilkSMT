...
public class PseudoPlacement extends Placement {
    ...
    public PseudoPlacement(Panel panel, String pseudoPlacementId) throws Exception {
        ...
        if (pair == null || pair.second == null) {
            throw new Exception(String.format(org.openpnp.Translations.getString("Local.fc4137c8ce692654"), pseudoPlacementId, panel.toString()));
        }
        branches = pair.first;
        leaf = pair.second;
    ...
    public static Location computeLocation(Panel panel, String pseudoPlacementId) throws Exception {
        ...
        if (pair == null || pair.second == null) {
            throw new Exception(String.format(org.openpnp.Translations.getString("Local.fc4137c8ce692654"), 
