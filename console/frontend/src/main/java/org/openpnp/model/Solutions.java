...
public class Solutions extends AbstractTableModel {
    ...
    public static abstract class Issue extends AbstractModelObject {
        ...
        private final Object displayedIssue;
        private final Object displayedSolution;

        public Issue(Subject subject, Object issue, Object solution, Severity severity, String uri) {
            super();
            this.subject = subject; 
            this.issue = Translations.original(issue);
            this.solution = Translations.original(solution);
        ...
        public String getIssue() {
            return displayedIssue instanceof Translations.Message ? displayedIssue.toString()
                    : Translations.translate(displayedIssue.toString());
        }
        public String getSolution() {
            return displayedSolution instanceof Translations.Message ? displayedSolution.toString()
                    : Translations.translate(displayedSolution.toString());
        }
    ...
    public static class PlainIssue extends Issue {
        ...
        public PlainIssue(Subject subject, Object issue, Object solution, Severity severity,
                String uri) {
    ...
    public static void applyTableUi(AutoSelectTextTable table) {
        ...
        //JComboBox statesComboBox = new org.openpnp.gui.components.LocalizedComboBox(Solutions.State.values());
