        ...
        switch (type) {
            case Dual: 
            {
                if (padCount % 2 != 0 || padCount <= 0) {
                    throw new Exception(org.openpnp.Translations.getString("Local.87f5e4a6e12381db"));
                }
            ...
            case Quad:
            {
                if (padCount % 4 != 0 || padCount <= 0) {
                    throw new Exception(org.openpnp.Translations.getString("Local.1d13ee4be8dbe23b"));
                }
                double padLength = (outerDimension - innerDimension)/2;
            ...
            case Bga:
            {
                ...
                if (Math.pow(rows, 2) != padCount) {
                    throw new Exception(org.openpnp.Translations.getString("Local.66e62123d90773a5"));
                }
                double d = (outerDimension + innerDimension)/4;
