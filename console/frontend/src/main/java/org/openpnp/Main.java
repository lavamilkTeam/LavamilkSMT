...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Load Swing's built-in dialogs after choosing the application's language.
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.info(String.format(org.openpnp.Translations.getString("Local.c7034266a1723ef4"), Main.getVersion()));
