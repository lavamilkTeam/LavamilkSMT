...
public abstract class AbstractSignaler extends AbstractModelObject implements Signaler, WizardConfigurable {
    ...
    public Action deleteAction = new AbstractAction(org.openpnp.Translations.getString("Local.19987d9e46507669")) {
        private static final long serialVersionUID = 1L;

        {
            putValue(SMALL_ICON, Icons.delete);
            putValue(NAME, org.openpnp.Translations.getString("Local.19987d9e46507669"));
