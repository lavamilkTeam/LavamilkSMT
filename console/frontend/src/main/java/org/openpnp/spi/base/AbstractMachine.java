...
public abstract class AbstractMachine extends AbstractModelObject implements Machine {
                ...
                try {
                    ...
                    try {
                        if (!ignoreEnabled && !isEnabled()) {
                            throw new Exception(org.openpnp.Translations.getString("Local.71c678565112037d"));
                        }
    ...
    public Head getDefaultHead() throws Exception {
        ...
        if (heads == null || heads.isEmpty()) {
            throw new Exception(org.openpnp.Translations.getString("Local.def20759c7849a31"));
        }
        return heads.get(0);
    }
