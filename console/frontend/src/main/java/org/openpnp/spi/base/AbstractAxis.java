...
public abstract class AbstractAxis extends AbstractModelObject implements Axis {
    ...
    public Action deleteAction = new AbstractAction(org.openpnp.Translations.getString("Local.9ae7bfe04975ddc4")) {
        {
            putValue(SMALL_ICON, Icons.delete);
            putValue(NAME, org.openpnp.Translations.getString("Local.9ae7bfe04975ddc4"));
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            int ret = JOptionPane.showConfirmDialog(MainFrame.get(),
                    message,
                    org.openpnp.Translations.format("Local.6474596f1237ff1b", (getName())), JOptionPane.YES_NO_OPTION);
    ...
    public Action permutateUpAction = new AbstractAction() {
        {
            ...
            putValue(NAME, org.openpnp.Translations.getString("Local.4c46f549b9cf6723"));
    ...
    public Action permutateDownAction = new AbstractAction() {
        {
            ...
            putValue(NAME, org.openpnp.Translations.getString("Local.c19c1a92a7e1204d"));
