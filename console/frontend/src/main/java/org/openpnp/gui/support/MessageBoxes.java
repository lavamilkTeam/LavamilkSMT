...
public class MessageBoxes {
    ...
    public static boolean errorBox(Component parent, String title, Throwable cause, boolean withContinuation) {
        ...
        if (message == null) {
            message = org.openpnp.Translations.getString("Local.cc44fc110dd06284");
        }
    ...
    public static void notYetImplemented(Component parent) {
        errorBox(parent, org.openpnp.Translations.getString("Local.ae9b02e3725937bf"), org.openpnp.Translations.getString("Local.5f73b5978b294aba"));
    }
}
