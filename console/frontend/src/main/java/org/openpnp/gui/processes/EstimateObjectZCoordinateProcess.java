...
public class EstimateObjectZCoordinateProcess {
    ...
    private String estimatedZStr = org.openpnp.Translations.getString("Local.ba691ba042bcedd9");

    private int step = -1;
    private String[] moveableCameraInstructions = new String[] {
            org.openpnp.Translations.getString("Local.1b1d0e871b8c2beb"),
            org.openpnp.Translations.getString("Local.d2df8d3dd53bd8ec"),
            org.openpnp.Translations.getString("Local.b187da476e550e66"),};
    private String[] fixedCameraInstructions = new String[] {
            org.openpnp.Translations.getString("Local.2a0dff0801586807"),
            org.openpnp.Translations.getString("Local.7a21e82f222a4f2b"),
            org.openpnp.Translations.getString("Local.b187da476e550e66"),};
    ...
    private void advance() {
        ...
        if (step > 2) {
            ...
            mainFrame.showInstructions(org.openpnp.Translations.format("Local.72bce75e8c378834"),
                    String.format(fixedCamera ? fixedCameraInstructions[step]
                            : moveableCameraInstructions[step], estimatedZStr),
                    true, step == 2, org.openpnp.Translations.format("Local.f72894d8fbb37340"), cancelActionListener, proceedActionListener);
        }
    }
    ...
    private boolean step2() {
        ...
        try {
            ...
            estimatedZStr = org.openpnp.Translations.getString("Local.17102527f73451d3") + ex.getMessage() + ")";
        }
        return true;
    }
