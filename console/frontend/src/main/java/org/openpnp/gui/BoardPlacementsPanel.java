...
public class BoardPlacementsPanel extends JPanel {
    ...
    private void createUi() {
        ...
        @SuppressWarnings("unchecked")
        JComboBox<PartsComboBoxModel> partsComboBox = new org.openpnp.gui.components.LocalizedComboBox<>(new PartsComboBoxModel());
        partsComboBox.setMaximumRowCount(20);
        partsComboBox.setRenderer(new IdentifiableListCellRenderer<Part>());
        JComboBox<Side> sidesComboBox = new org.openpnp.gui.components.LocalizedComboBox<>(Side.values());
        ...
        JComboBox<Type> typesComboBox = new org.openpnp.gui.components.LocalizedComboBox<>(new Type[] { Type.Placement, Type.Fiducial });
        JComboBox<ErrorHandling> errorHandlingComboBox = new org.openpnp.gui.components.LocalizedComboBox<>(ErrorHandling.values());
