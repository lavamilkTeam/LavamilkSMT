...
public class PadsTableModel extends AbstractTableModel {
    ...
    private String[] columnNames = new String[] {org.openpnp.Translations.getString("Core.Label.Name"), org.openpnp.Translations.getString("Core.Label.Side"), "X", "Y", org.openpnp.Translations.getString("Core.Label.Rotation"), org.openpnp.Translations.getString("Core.Label.Type")};
