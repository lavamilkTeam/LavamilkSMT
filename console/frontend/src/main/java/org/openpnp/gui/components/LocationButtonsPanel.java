...
public class LocationButtonsPanel extends JPanel {
    ...
    public Actuator getActuator() throws Exception {
        ...
        if (actuator == null) {
            throw new Exception(String.format(org.openpnp.Translations.getString("Local.981962afe95ef8ae"), actuatorName,
                    head.getName()));
        }
        return actuator;
    }
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            if (isContactProbeReference()) {
                ...
                result = JOptionPane.showConfirmDialog(getTopLevelAncestor(),
                        org.openpnp.Translations.getString("Local.6fa32d04c50e8527"),
            ...
            if (result == JOptionPane.YES_OPTION) {
                UiUtils.submitUiMachineTask(() -> {
                    ...
                    if (! (tool instanceof ContactProbeNozzle)) {
                        throw new Exception(org.openpnp.Translations.format("Local.f0dc6e86414e39a5", (tool.getName())));
                    }
