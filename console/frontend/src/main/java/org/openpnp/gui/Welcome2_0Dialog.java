...
public class Welcome2_0Dialog extends JDialog {
    ...
    public Welcome2_0Dialog(Frame frame) {
        ...
        JLabel lblCopyright = new JLabel(org.openpnp.Translations.getString("Local.d8e7cf1b68309e18"));
        ...
        try {
            String welcomeFile = "zh".equals(java.util.Locale.getDefault().getLanguage())
                    ? "OPENPNP_2_0_zh_CN.md" : "OPENPNP_2_0.md";
            String s = FileUtils.readFileToString(new File(welcomeFile), java.nio.charset.StandardCharsets.UTF_8);
