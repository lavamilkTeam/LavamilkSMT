...
public class CameraVisionConfigurationWizard extends AbstractConfigurationWizard {
    ...
    public CameraVisionConfigurationWizard(AbstractSettlingCamera camera) {
        ...
        settleMethod = new org.openpnp.gui.components.LocalizedComboBox(AbstractSettlingCamera.SettleMethod.values());
        ...
        UiUtils.messageBoxOnException(() -> {
            ...
            if ((x != 0 || y != 0) 
                ...
                int result = JOptionPane.showConfirmDialog(getTopLevelAncestor(),
                        org.openpnp.Translations.format("Local.65d6b18e015132b9", (jogTool.getName()), (((jogTool instanceof Camera) ? "" : org.openpnp.Translations.getString("Local.7d58226e894f7b43")))),
