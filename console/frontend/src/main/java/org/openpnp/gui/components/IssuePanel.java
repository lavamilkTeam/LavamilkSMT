            ...
            if (property instanceof StringProperty) {
                ...
                if (property instanceof MultiLineTextProperty) {
                    ...
                    if (stringProperty.getSuggestions() != null) {
                        ...
                        JLabel lbl2 = new JLabel(org.openpnp.Translations.getString("Local.ff6189f9a1e4aefb"));
                        lbl2.setToolTipText(stringProperty.getSuggestionToolTip());
                        suggestPanel.add(lbl2, BorderLayout.WEST);
                        JComboBox comboBox = new org.openpnp.gui.components.LocalizedComboBox(stringProperty.getSuggestions());
