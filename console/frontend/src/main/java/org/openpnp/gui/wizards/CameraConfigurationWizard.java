...
public class CameraConfigurationWizard extends AbstractConfigurationWizard {
    ...
    public CameraConfigurationWizard(AbstractBroadcastingCamera camera) {
        ...
        lookingCb = new org.openpnp.gui.components.LocalizedComboBox(Camera.Looking.values());
        ...
        focusSensingMethod = new org.openpnp.gui.components.LocalizedComboBox(FocusSensingMethod.values());
        ...
        lightActuator = new org.openpnp.gui.components.LocalizedComboBox();
        ...
        panelCal = new JPanel();
        panelCal.setName(org.openpnp.Translations.getString("Local.378ba34654c06f5a"));
    ...
    private Action captureToolZAction = new AbstractAction("", Icons.captureTool) {
        {
            putValue(Action.SHORT_DESCRIPTION,
                    org.openpnp.Translations.getString("Local.ae9027d14eee3aca"));
        }
    ...
    private Action measure1Action = new AbstractAction(Translations.getString(
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            try {
                ...
                MessageBoxes.errorBox(MainFrame.get(), org.openpnp.Translations.getString("Local.54a0e8c17ebb21a1"), e);
    ...
    protected void measure(int measurement) throws Exception {
        ...
        if (!enableUnitsPerPixel3D.isSelected()) {
            ...
            if (measurement == 2 
                ...
                throw new Exception(org.openpnp.Translations.getString("Local.e5f36b6bde787f39"));
            }
            if (!nozzleLocation.equals(desiredNozzleLocation)) {
                int result = JOptionPane.showConfirmDialog(getTopLevelAncestor(),
                        org.openpnp.Translations.format("Local.f2a4254179130870", (nozzle.getName()), (camera.getName())),
                                null, JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
                if (result == JOptionPane.NO_OPTION) {
                    throw new Exception(org.openpnp.Translations.getString("Local.56f141c0ec72c809"));
                }
            ...
            measurementLocation = nozzle.getLocation()
                    .convertToUnits(units);
            int result = JOptionPane.showConfirmDialog(getTopLevelAncestor(),
                    org.openpnp.Translations.format("Local.a1000894292cc6c0", (camera.getName()), (nozzle.getName())),
                            null, JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
            if (result == JOptionPane.NO_OPTION) {
                throw new Exception(org.openpnp.Translations.getString("Local.56f141c0ec72c809"));
            }
