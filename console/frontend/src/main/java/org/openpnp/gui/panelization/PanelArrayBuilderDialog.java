        ...
        {
            {
                ...
                JComboBox<ArrayType> comboBoxArrayType = new org.openpnp.gui.components.LocalizedComboBox<>();
            ...
            panel.setLayout(new BorderLayout(0, 0));
            {
                ...
                panelControls.setLayout(new CardLayout(0, 0));
                {
                    ...
                    }
                    {
                        ...
                        JComboBox<String> comboBoxAlternateRows = new org.openpnp.gui.components.LocalizedComboBox<String>();
