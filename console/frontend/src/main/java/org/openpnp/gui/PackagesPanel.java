...
public class PackagesPanel extends JPanel implements WizardContainer {
    ...
    public PackagesPanel(Configuration configuration, Frame frame) {
        ...
        JComboBox<BottomVisionSettings> fiducialVisionCombo = new org.openpnp.gui.components.LocalizedComboBox<>(
    ...
    public final Action newPackageAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            while ((id = JOptionPane.showInputDialog(frame,
                    org.openpnp.Translations.getString("Local.51bfe39679621e51"))) != null) {
                id = id.trim();
                if (id.isEmpty()) {
                    break;
                }
                if (configuration.getPackage(id) != null) {
                    MessageBoxes.errorBox(frame, org.openpnp.Translations.getString("Local.54a0e8c17ebb21a1"), org.openpnp.Translations.format("Local.e4627d4e06957dda", (id)));
                    continue;
                }
    ...
    public final Action pastePackageToClipboardAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent arg0) {
            String id;
            while ((id = JOptionPane.showInputDialog(frame,
                    org.openpnp.Translations.getString("Local.3c74c706471961a7"))) != null) {
                id = id.trim();
                if (id.isEmpty()) {
                    break;
                }
