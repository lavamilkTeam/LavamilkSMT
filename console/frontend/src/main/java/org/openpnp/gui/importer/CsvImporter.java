...
public abstract class CsvImporter {
    ...
    private List<Placement> parseFile(File file, boolean createMissingParts,
        ...
        if (len <= 0) {
            reader.close();
            throw new Exception(org.openpnp.Translations.getString("Local.2b57119ef4a7a279")); //$NON-NLS-1$
        }
    ...
    class Dlg extends JDialog {
        ...
        private class SwingAction_2 extends AbstractAction {
            ...
            public void actionPerformed(ActionEvent e) {
                Logger.debug("Parsing " + textFieldFile.getText() + org.openpnp.Translations.getString("Local.00ffa6e4677b8aac")); //$NON-NLS-1$ //$NON-NLS-2$
