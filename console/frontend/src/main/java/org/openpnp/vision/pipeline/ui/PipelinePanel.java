    ...
    private void refreshProperties() {
        ...
        if (stage == null) {
            ...
            try {
                ...
                pipelinePropertySheetTable.localizeEnumProperties();
    ...
    public Action newStageAction = new AbstractAction() {
        {
            ...
            putValue(NAME, org.openpnp.Translations.getString("Local.660eec513497aec2"));
            putValue(SHORT_DESCRIPTION, org.openpnp.Translations.getString("Local.741b605218b2aa5c"));
        }
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            ClassSelectionDialog<CvStage> dialog = new ClassSelectionDialog<>(
                    JOptionPane.getFrameForComponent(PipelinePanel.this), org.openpnp.Translations.format("Local.0c5249b6ac7ddda2"),
                    org.openpnp.Translations.format("Local.b0e46d3d4c44ad3a"), stageClasses);
            ...
            try {
                ...
                MessageBoxes.errorBox(JOptionPane.getFrameForComponent(PipelinePanel.this), org.openpnp.Translations.getString("Local.54a0e8c17ebb21a1"),
                        e);
            }
        }
    };
    ...
    public Action deleteStageAction = new AbstractAction() {
        {
            ...
            putValue(NAME, org.openpnp.Translations.getString("Local.dab213b7cdbeef40"));
            putValue(SHORT_DESCRIPTION, org.openpnp.Translations.getString("Local.62c2b90239c8da58"));
        }
    ...
    public final Action copyAction = new AbstractAction() {
        {
            ...
            putValue(NAME, org.openpnp.Translations.getString("Local.f05c52c3125d1fb4"));
            putValue(SHORT_DESCRIPTION, org.openpnp.Translations.getString("Local.7e930fccfd83d295"));
        }
        ...
        public void actionPerformed(ActionEvent arg0) {
            try {
                ...
                MessageBoxes.errorBox(getTopLevelAncestor(), org.openpnp.Translations.getString("Local.5b50e7a693fee952"), e);
            }
        }
    };
    ...
    public final Action pasteAction = new AbstractAction() {
        {
            ...
            putValue(NAME, org.openpnp.Translations.getString("Local.feea1a0d00e221e9"));
            putValue(SHORT_DESCRIPTION,
                    org.openpnp.Translations.getString("Local.52b79c2162de6e6e"));
        }
        ...
        public void actionPerformed(ActionEvent arg0) {
            try {
                ...
                MessageBoxes.errorBox(getTopLevelAncestor(), org.openpnp.Translations.getString("Local.bc865f1f603a8331"), e);
            }
        }
    };
    ...
    public final Action refreshAction = new AbstractAction() {
        {
            ...
            putValue(NAME, org.openpnp.Translations.getString("Local.1aad173dc78ecd79"));
            putValue(SHORT_DESCRIPTION, org.openpnp.Translations.getString("Local.1aad173dc78ecd79"));
        }
    ...
    public final Action stepNextShotAction = new AbstractAction() {
        {
            ...
            putValue(NAME, org.openpnp.Translations.getString("Local.c0fa95100ca6d8bb"));
            putValue(SHORT_DESCRIPTION, org.openpnp.Translations.getString("Local.c0fa95100ca6d8bb"));
        }
