...
public abstract class CvStage {
    ...
    public String getCategory() {
        try {
            ...
            return org.openpnp.Translations.translate(a.category());
        }
        catch (Exception e) {
            return null;
        }
    ...
    public String getDescription() {
        try {
            Stage a = getClass().getAnnotation(Stage.class);
            return org.openpnp.Translations.translate(a.description());
        }
        catch (Exception e) {
            return null;
        }
    ...
    public class CvStageBeanInfo implements BeanInfo {
        ...
        public PropertyDescriptor[] getPropertyDescriptors() {
            ...
            for (PropertyDescriptor pd : pds) {
                ...
                pd.setDisplayName(org.openpnp.Translations.visionLabel("Property", propertyName));
    ...
    public static class Result {
        ...
        public <T> T getExpectedModel(Class<T> expectedModelClass) throws Exception {
            ...
            T typedModel = null;
            if (model == null) {
                throw new Exception(org.openpnp.Translations.format("Local.825bbe995f8c8e73", (getName()), (expectedModelClass.getSimpleName())));
            }
            if (expectedModelClass.isInstance(model)) {
                typedModel = (T)model;
            }
            if (typedModel == null) {
                throw new Exception(org.openpnp.Translations.format("Local.587ba1817ca674ad", (getName()), (model.getClass().getSimpleName()), (expectedModelClass.getSimpleName())));
            }
            return typedModel;
        }
        ...
        public <T> List<T> getExpectedListModel(Class<T> expectedElementClass, Exception emptyException) throws Exception {
            ...
            if (!expectedElementClass.isInstance(list.get(0))) {
                throw new Exception(org.openpnp.Translations.format("Local.44796826bce6ad7a", (getName()), (list.get(0).getClass().getSimpleName()), (expectedElementClass.getSimpleName())));
            }
            return (List<T>)list;
        }
        ...
        for (Class<?> acceptablePropertyClass : acceptablePropertyTypes) {
            if (acceptablePropertyClass.isInstance(pipelineProperty)) {
                if (parameter.getClass().isInstance(pipelineProperty)) {
                    ...
                    if (camera == null) {
                        throw new Exception(org.openpnp.Translations.getString("Local.6d460f7b3c70ac2e"));
                    }
                ...
                throw new Exception(org.openpnp.Translations.format("Local.d332ac63bd07db29", (pipelinePropertyName), (acceptablePropertyClass), (parameter.getClass())));
            }
            acceptableTypeList += (acceptableTypeList.length() != 0 ? " or \"" : "\"") + acceptablePropertyClass.getName() + "\"";
        }
        throw new Exception(org.openpnp.Translations.format("Local.671c45309b701afc", (pipelinePropertyName), (acceptableTypeList)));
    }
