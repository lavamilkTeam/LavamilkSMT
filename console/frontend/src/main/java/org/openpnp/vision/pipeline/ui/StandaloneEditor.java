...
public class StandaloneEditor extends JFrame {
    ...
    public StandaloneEditor() {
        ...
        setTitle(org.openpnp.Translations.getString("Local.94d46140ca1bbecd"));
        setSize(1328, 1022);
        ...
        if (defaultPipeline != null) {
            try {
                ...
                System.out.println(org.openpnp.Translations.getString("Local.8d28005179b7fe15") + e.getMessage());
            }
        }
