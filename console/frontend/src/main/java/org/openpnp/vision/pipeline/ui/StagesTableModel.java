...
public class StagesTableModel extends AbstractTableModel implements Reorderable {
    private static String[] columnNames = {org.openpnp.Translations.getString("Core.Label.Enabled"), org.openpnp.Translations.getString("Core.Label.Name"), org.openpnp.Translations.getString("Core.Label.Stage")};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                return org.openpnp.Translations.displayClass(stage.getClass());
        }
        return null;
    }
