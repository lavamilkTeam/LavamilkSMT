...
public class MinAreaRect extends CvStage {
    ...
    public Result process(CvPipeline pipeline) throws Exception {
        if (pipeline.getWorkingColorSpace() != FluentCv.ColorSpace.Gray){
            throw new Exception(String.format(org.openpnp.Translations.getString("Local.fc49bb14c0064d1d"), MinAreaRect.class.getSimpleName(), pipeline.getWorkingColorSpace()));
        }
