...
public class ResultsPanel extends JPanel {
    ...
    public ResultsPanel(CvPipelineEditor editor) {
        ...
        resultStageNameLabel = new JLabel(org.openpnp.Translations.getString("Local.2bda0a8b27535eb5"));
            ...
            if (result != null) {
                try {
                    ...
                    try {
                        ...
                        pipelineStr = org.openpnp.Translations.getString("Local.68e0990f94febd42") + ex.toString();
                    }
    ...
    public final Action firstResultAction = new AbstractAction() {
        {
            ...
            putValue(NAME, "");
            putValue(SHORT_DESCRIPTION, org.openpnp.Translations.getString("Local.07aba9130275b21c"));
        }
    ...
    public final Action previousResultAction = new AbstractAction() {
        {
            ...
            putValue(NAME, "");
            putValue(SHORT_DESCRIPTION, org.openpnp.Translations.getString("Local.c8847738b955a9de"));
        }
    ...
    public final Action nextResultAction = new AbstractAction() {
        {
            ...
            putValue(NAME, "");
            putValue(SHORT_DESCRIPTION, org.openpnp.Translations.getString("Local.09e83989beac53f0"));
        }
    ...
    public final Action lastResultAction = new AbstractAction() {
        {
            ...
            putValue(NAME, "");
            putValue(SHORT_DESCRIPTION, org.openpnp.Translations.getString("Local.585174cdb9a7e940"));
        }
    ...
    public final Action pinResultAction = new AbstractAction() {
        {
            ...
            putValue(NAME, "");
            putValue(SHORT_DESCRIPTION, org.openpnp.Translations.getString("Local.46b2ec03b035e902"));
        }
    ...
    public final Action colorResultAction = new AbstractAction() {
        {
            ...
            putValue(NAME, "");
            putValue(SHORT_DESCRIPTION, org.openpnp.Translations.getString("Local.fbe993482a8c241c"));
        }
        ...
        public void actionPerformed(ActionEvent arg0) {
            if (displayTrueColors) {
                ...
                putValue(SHORT_DESCRIPTION, org.openpnp.Translations.getString("Local.cb07cec40503b0a5"));
            }
            else {
