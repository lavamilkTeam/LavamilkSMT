...
public class CreateShapeTemplateImage extends CvStage {
    ...
    public Result process(CvPipeline pipeline) throws Exception {
        ...
        if (camera == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.20f739d146405463"));
        }
        if (shape == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.ae6e9095d94a99d4"));
        }
        ...
        if (bounds.getWidth() == 0 || bounds.getHeight() == 0) {
            throw new Exception(
                    org.openpnp.Translations.getString("Local.3086e3f01a31070c"));
        }
