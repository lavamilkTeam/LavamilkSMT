...
public class DetectFixedCirclesHough extends CvStage {
    ...
    public Result process(CvPipeline pipeline) throws Exception {
        ...
        if (camera == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.9e05a347565aee1a"));
        }
        ...
        if ((minDistance == null) || (minDiameter == null) || (maxDiameter == null)) {
            throw new Exception(org.openpnp.Translations.getString("Local.5b08e01bca6fb8d2"));
        }
