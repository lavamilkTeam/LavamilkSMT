        ...
        if (model instanceof List) {
            ...
            for (Object item : (List)model) {
                if ((item) instanceof Result.Circle) {
                    ...
                    throw new Exception(org.openpnp.Translations.getString("Local.717335c9494495f9"));
                }
            }
            ...
            throw new Exception(org.openpnp.Translations.getString("Local.57c11f36afc5087a"));
        }
    }
