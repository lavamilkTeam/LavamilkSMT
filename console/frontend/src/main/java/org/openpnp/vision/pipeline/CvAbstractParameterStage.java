...
public abstract class CvAbstractParameterStage extends CvStage {
    ...
    public Result process(CvPipeline pipeline) throws Exception {
        if (parameterName() == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.1331836abc2c1db7"));
        }
        ...
        if (stage == null) {
            throw new Exception(org.openpnp.Translations.format("Local.1e5b87aff450f1ff", (stageName)));
        }
