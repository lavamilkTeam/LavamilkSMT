...
public class ReadModelProperty extends CvStage {
    ...
    public Result process(CvPipeline pipeline) throws Exception {
        if (modelStageName == null || modelStageName.trim().isEmpty()) {
            throw new Exception(org.openpnp.Translations.getString("Local.c0501dbbe8cb1822"));
        }
        
        if (propertyName == null || propertyName.trim().isEmpty()) {
            throw new Exception(org.openpnp.Translations.getString("Local.dac7dbcc043ce54c"));
        }
