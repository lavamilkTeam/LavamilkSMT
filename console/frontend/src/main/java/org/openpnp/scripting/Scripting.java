...
public class Scripting {
    ...
    public void execute(File script, Map<String, Object> additionalGlobals) throws Exception {
        ...
        if(engineName==null) {
            throw new Exception(org.openpnp.Translations.format("Local.0c486aa6b7090aa5", (extension)));
        }
        ...
        if (usePool) {
            ...
            if(engine==null) {
                throw new Exception(org.openpnp.Translations.format("Local.35ae80ff93384463", (engineName)));
            }
            ...
            elapsedTimeNs = System.nanoTime() - startTimeNs;
            if(engine==null) {
                throw new Exception(org.openpnp.Translations.format("Local.9953a7677d650df4", (engineName)));
            }
