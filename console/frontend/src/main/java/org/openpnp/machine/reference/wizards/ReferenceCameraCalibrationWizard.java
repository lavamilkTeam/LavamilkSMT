...
public class ReferenceCameraCalibrationWizard extends AbstractConfigurationWizard {
    ...
    private Action overrideAction = new AbstractAction(org.openpnp.Translations.getString("Local.75cd994a28004a3a")) {
        @Override
    ...
    private Action enableAction = new AbstractAction(org.openpnp.Translations.getString("Local.dec5ceece0dfd7cd")) {
        @Override
        public void actionPerformed(ActionEvent e) {
            referenceCamera.setHeadOffsets(referenceCamera.getHeadOffsets());
        }
    ...
    private Action showOutliersActionListener = new AbstractAction(org.openpnp.Translations.getString("Local.025da045339505bf")) {
        @Override
        public void actionPerformed(ActionEvent e) {
            updateDiagnosticsDisplay();
        }
    ...
    private Action startCalibration = new AbstractAction(org.openpnp.Translations.getString("Local.f79e40a2b032a74c")) {
        @Override
        public void actionPerformed(ActionEvent e) {
            //Pre-calibration checks
            if (!Configuration.get().getMachine().isHomed()) {
                MessageBoxes.errorBox(MainFrame.get(), org.openpnp.Translations.getString("Local.54a0e8c17ebb21a1"), org.openpnp.Translations.getString("Local.5161342cc01d55ee"));
                return;
            }
            if (advCal.getPrimaryLocation() == null || advCal.getSecondaryLocation() == null) {
                if (isMovable) {
                    MessageBoxes.errorBox(MainFrame.get(), org.openpnp.Translations.getString("Local.54a0e8c17ebb21a1"), org.openpnp.Translations.getString("Local.161ee0925bd2c865"));
                    return;
                }
                else {
                    MessageBoxes.errorBox(MainFrame.get(), org.openpnp.Translations.getString("Local.54a0e8c17ebb21a1"), org.openpnp.Translations.getString("Local.37507904ccc7ed11"));
                    return;
                }
            }
            if (!Double.isFinite(advCal.getPrimaryLocation().getZ()) || !Double.isFinite(advCal.getSecondaryLocation().getZ())) {
                MessageBoxes.errorBox(MainFrame.get(), org.openpnp.Translations.getString("Local.54a0e8c17ebb21a1"), org.openpnp.Translations.getString("Local.d55daa91f436cca4"));
                return;
            }
            if (advCal.getPrimaryLocation().getZ() == advCal.getSecondaryLocation().getZ()) {
                MessageBoxes.errorBox(MainFrame.get(), org.openpnp.Translations.getString("Local.54a0e8c17ebb21a1"), org.openpnp.Translations.getString("Local.4d86ac4ed6fb50e8"));
                return;
            }
            if (referenceCamera.getDefaultZ() == null || !Double.isFinite(referenceCamera.getDefaultZ().getValue())) {
                MessageBoxes.errorBox(MainFrame.get(), org.openpnp.Translations.getString("Local.54a0e8c17ebb21a1"), org.openpnp.Translations.getString("Local.0c6546c0e8ca00e5"));
                return;
            }
            ...
            try {
                ...
                if (!chckbxUseSavedData.isSelected()) {
                    ...
                    try {
                        ...
                        MessageBoxes.errorBox(MainFrame.get(), org.openpnp.Translations.getString("Local.54a0e8c17ebb21a1"), ex);
                        advCal.setValid(false);
                        advCal.setEnabled(false);
                        chckbxEnable.setSelected(false);
                        chckbxEnable.setEnabled(false);
    ...
    private void postCalibrationProcessing() throws Exception {
        ...
        if (isMovable && referenceCamera.getHead().getDefaultCamera() == referenceCamera) {
            int ans = JOptionPane.showConfirmDialog(MainFrame.get(), 
                    org.openpnp.Translations.getString("Local.e30b80e6ff5614b1"), 
                    org.openpnp.Translations.getString("Local.86f013746e182a21"), JOptionPane.YES_NO_OPTION);
