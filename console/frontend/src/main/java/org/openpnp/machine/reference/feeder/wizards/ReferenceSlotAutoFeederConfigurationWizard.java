...
public class ReferenceSlotAutoFeederConfigurationWizard
    ...
    public ReferenceSlotAutoFeederConfigurationWizard(ReferenceSlotAutoFeeder feeder) {
        ...
        JLabel lblActuatorValue = new JLabel(org.openpnp.Translations.getString("Local.d0fffbc03877aabe"));
        panelActuator.add(lblActuatorValue, "6, 2, left, default");

        JLabel lblFeed = new JLabel(org.openpnp.Translations.getString("Local.396c3cb18f811a18"));
        ...
        JLabel lblForBoolean = new JLabel(org.openpnp.Translations.getString("Local.28a540333aaa054b"));
        ...
        JLabel lblForBoolean_1 = new JLabel(org.openpnp.Translations.getString("Local.28a540333aaa054b"));
        ...
        JLabel lblMoveBeforeFeed = new JLabel(org.openpnp.Translations.getString("Local.d8648da519f93249"));
        panelActuator.add(lblMoveBeforeFeed, "2, 8, right, default");
        lblMoveBeforeFeed.setToolTipText(org.openpnp.Translations.getString("Local.35234fbda337e82a"));
        ...
        JLabel lblRetryCount = new JLabel(org.openpnp.Translations.getString("Local.9f59e0267cd9701f"));
    ...
    private Action newFeederAction = new AbstractAction(org.openpnp.Translations.getString("Local.18fdd549b2ed367a")) {
        @Override
