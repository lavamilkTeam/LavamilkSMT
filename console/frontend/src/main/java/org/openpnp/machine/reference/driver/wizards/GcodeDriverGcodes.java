...
public class GcodeDriverGcodes extends AbstractConfigurationWizard {
    ...
    public GcodeDriverGcodes(GcodeDriver driver) {
        ...
        comboBoxHm = new org.openpnp.gui.components.LocalizedComboBox<>();
        ...
        comboBoxCommandType = new org.openpnp.gui.components.LocalizedComboBox<>();
...
//        importExportPanel.add(btnResetToDefaults, "2, 8");
            ...
            try {
                ...
                if (file.exists()) {
                    int ret = JOptionPane.showConfirmDialog(getTopLevelAncestor(),
                            org.openpnp.Translations.format("Local.e638d3d2c650fe25", (file.getName())),
                            org.openpnp.Translations.getString("Local.d1d984b8b0724497"), JOptionPane.YES_NO_OPTION,
                ...
                MessageBoxes.errorBox(MainFrame.get(), org.openpnp.Translations.getString("Local.9a5e4d9513126f64"), e);
            }
        }
    };
    ...
    public final Action importProfileAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent arg0) {
            try {
                ...
                MessageBoxes.errorBox(MainFrame.get(), org.openpnp.Translations.getString("Local.09876dabd9db71a6"), e);
            }
        }
    };
    ...
    public final Action copyProfileToClipboardAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent arg0) {
            try {
                ...
                MessageBoxes.errorBox(MainFrame.get(), org.openpnp.Translations.getString("Local.2c58b2d4975aadc6"), e);
            }
        }
    };
    ...
    public final Action pasteProfileFromClipboardAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent arg0) {
            try {
                ...
                MessageBoxes.errorBox(MainFrame.get(), org.openpnp.Translations.getString("Local.3b3af9fe7c41ab4e"), e);
            }
        }
    };
    public final Action resetToDefaultAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent arg0) {
            try {
                int ret = JOptionPane.showConfirmDialog(getTopLevelAncestor(),
                        org.openpnp.Translations.getString("Local.a9142ccd0d2a9ffa"), 
                        org.openpnp.Translations.getString("Local.e240e635ff6dce4f"),
                ...
                MessageBoxes.errorBox(MainFrame.get(), org.openpnp.Translations.getString("Local.32d721990e0ae79e"), e);
            }
        }
    };
