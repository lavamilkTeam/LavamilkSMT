...
public class AbstractReferenceDriverConfigurationWizard extends AbstractConfigurationWizard {
    ...
    public AbstractReferenceDriverConfigurationWizard(AbstractReferenceDriver driver) {
        ...
        communicationsType = new org.openpnp.gui.components.LocalizedComboBox(CommunicationsType.values());
        ...
        lineEndingType = new org.openpnp.gui.components.LocalizedComboBox(LineEndingType.values());
        ...
        comboBoxPort = new org.openpnp.gui.components.LocalizedComboBox();
        ...
        comboBoxBaud = new org.openpnp.gui.components.LocalizedComboBox();
        ...
        parityComboBox = new org.openpnp.gui.components.LocalizedComboBox(SerialPortCommunications.Parity.values());
        ...
        dataBitsComboBox = new org.openpnp.gui.components.LocalizedComboBox(SerialPortCommunications.DataBits.values());
        ...
        stopBitsComboBox = new org.openpnp.gui.components.LocalizedComboBox(SerialPortCommunications.StopBits.values());
        ...
        flowControlComboBox = new org.openpnp.gui.components.LocalizedComboBox(SerialPortCommunications.FlowControl.values());
