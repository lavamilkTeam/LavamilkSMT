...
public class Neoden4CameraConfigurationWizard extends AbstractConfigurationWizard {
    ...
    public Neoden4CameraConfigurationWizard(Neoden4Camera camera) {
        ...
        panelGeneral.setBorder(new TitledBorder(null,
                org.openpnp.Translations.getString("Local.c910d474dcd724bf"), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
        ...
        lblTimeout = new JLabel(org.openpnp.Translations.getString("Local.70594d932950a164"));
        ...
        lbluseForTimeout = new JLabel(org.openpnp.Translations.getString("Local.3648e72aebb8bad6"));
        panelGeneral.add(lbluseForTimeout, "6, 6");
                
        panelImage = new JPanel();
        contentPanel.add(panelImage);
        panelImage.setBorder(new TitledBorder(null, 
        		org.openpnp.Translations.getString("Local.01898f5eccedd4d9"), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
        ...
        lblImageWidth = new JLabel(org.openpnp.Translations.getString("Local.3019947b6daf18b0"));
        ...
        lblShiftX = new JLabel(org.openpnp.Translations.getString("Local.c7fe4202b50c0690"));
        ...
        lblXPixels = new JLabel(org.openpnp.Translations.getString("Local.72c345282e4e2dc4"));
        panelImage.add(lblXPixels, "12, 2");

        lblImageHeight = new JLabel(org.openpnp.Translations.getString("Local.bfe2eca401797325"));
        ...
        lblShiftY = new JLabel(org.openpnp.Translations.getString("Local.80f9ad657681d4ff"));
        ...
        lblYPixels = new JLabel(org.openpnp.Translations.getString("Local.72c345282e4e2dc4"));
