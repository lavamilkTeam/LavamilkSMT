                ...
                case ConfirmInRangeAfterAxesMove:
                    if (beforeMove 
                        ...
                        if (confirmation < confirmationGoodMin) {
                            conditionalActuatorLastState = null;
                            throw new Exception(org.openpnp.Translations.format("Local.9ff359b93a392a7a", (actuator.getName()), (confirmation), (confirmationGoodMin))); 
                        }
                        if (confirmation > confirmationGoodMax) {
                            conditionalActuatorLastState = null;
                            throw new Exception(org.openpnp.Translations.format("Local.5fdf5d53dddaffd7", (actuator.getName()), (confirmation), (confirmationGoodMax))); 
                        }
                    }
                    break;
                ...
                case ConfirmMatchAfterAxesMove:
                    if (beforeMove 
                        ...
                        if (!(confirmationByRegex ? 
                            ...
                            conditionalActuatorLastState = null;
                            throw new Exception(org.openpnp.Translations.format("Local.0130c1bee594ae2a", (actuator.getName()), (confirmation), (confirmationPattern))); 
                        }
                    }
                    break;
                default:
