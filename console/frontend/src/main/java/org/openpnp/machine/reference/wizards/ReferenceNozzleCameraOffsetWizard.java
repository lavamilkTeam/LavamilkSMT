...
public class ReferenceNozzleCameraOffsetWizard extends AbstractConfigurationWizard {
    ...
    public ReferenceNozzleCameraOffsetWizard(ReferenceNozzle nozzle) {
        ...
        camerasComboBox = new org.openpnp.gui.components.LocalizedComboBox<>();
    ...
    private Action openAdviceUrl = new AbstractAction(org.openpnp.Translations.getString("Local.6078f9163eb0d99b")) {
        @Override
