...
public class ReferenceNozzleTipCalibration extends AbstractModelObject {
    ...
    public void calibrate(ReferenceNozzle nozzle, boolean homing, boolean calibrateCamera) throws Exception {
        ...
        if (!(homing || Configuration.get().getMachine().isHomed())) {
            throw new Exception(org.openpnp.Translations.getString("Local.a86b0f66ed5f3b0f"));
        }

        if (nozzle == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.f18d469734152251"));
        }

        if (nozzle.getPart()!= null) {
            throw new Exception(org.openpnp.Translations.format("Local.a3dec6867d3fc9f8", (nozzle.getName())));
        }
        ...
        try {
            ...
            if (! calibrateCamera) {
                ...
                if (! isCalibrated(nozzle)) {
                    throw new Exception(org.openpnp.Translations.getString("Local.4531bf8495b2d92b")); 
                }
                if (referenceCamera == null) {
                    throw new Exception(org.openpnp.Translations.getString("Local.7088ad503268f565")); 
                }
            ...
            for (int i = 0; i <= angleSubdivisions; i++) {
                ...
                if (offset != null) {
                    ...
                    if (misdetects > this.allowMisdetections) {
                        throw new Exception(
                                org.openpnp.Translations.format("Local.3649d7aa7ed926aa", (nozzle.getNozzleTip().getName()), (nozzle.getName())));
                    }
                }
            }
        ...
        try (CvPipeline pipeline = getPreparedPipeline(camera, nozzle, measureLocation)) {
            ...
            for (Object result : results) {
                if ((result) instanceof Result.Circle) {
                    ...
                    throw new Exception(org.openpnp.Translations.format("Local.0f04b445ab9c4c63", (result)));
                }
            }
        ...
        try{
            ...
            if (nozzleTip != null 
                ...
                if (getBackgroundCalibrationMethod() == BackgroundCalibrationMethod.BrightnessAndKeyColor) {
                    ...
                    report.append("<html>");
                    report.append(org.openpnp.Translations.getString("Local.904f3206c31af1c0"));
                    if (bestMinValue > backgroundWorstValue) {
                        report.append(org.openpnp.Translations.getString("Local.91c977b96f895896"));
                    }
                    else if (bestMinValue > backgroundWorstValue/2) {
                        report.append(org.openpnp.Translations.getString("Local.3644aae5ae976d35"));
                    }
                    else if (bestMinValue <= minBackgroundMaskValue) {
                        report.append(org.openpnp.Translations.getString("Local.c3ecc1a8bcbce61c"));
                    }
                    else {
                        report.append(org.openpnp.Translations.getString("Local.7d7022610cdabc35"));
                    }
                    if (bestMinValue <= backgroundWorstValue) {
                        report.append("<hr/>");
                        report.append(org.openpnp.Translations.getString("Local.a29331b5c7d45d97"));
                        if (hueSpan > backgroundWorstHueSpan) {
                            report.append(org.openpnp.Translations.getString("Local.28854330ffe31858")
                                    + (bestMinValue <= backgroundWorstValue ? 
                                            org.openpnp.Translations.getString("Local.c310aa47c1b71785") : "")
                                    + org.openpnp.Translations.getString("Local.0349a119c2c3573b"));
                        }
                        else if (hueSpan > backgroundWorstHueSpan/2) {
                            report.append(org.openpnp.Translations.getString("Local.16d1db4c92b8ea2b"));
                        }
                        else if (hueSpan > 1) {
                            report.append(org.openpnp.Translations.getString("Local.f8c155a93e56fa1e"));
                        }
                        else {
                            report.append(org.openpnp.Translations.getString("Local.51034c5d3c1358d1"));
                        }
                        if (hueSpan <= backgroundWorstHueSpan) {
                            report.append("<hr/>");
                            report.append(org.openpnp.Translations.getString("Local.a29331b5c7d45d97"));
                            if (bestMinSaturation < backgroundWorstSaturation) {
                                report.append(org.openpnp.Translations.getString("Local.af7d531f9c133564")
                                        + (bestMinValue <= backgroundWorstValue ? 
                                                org.openpnp.Translations.getString("Local.c310aa47c1b71785") : "")
                                        + org.openpnp.Translations.getString("Local.631ebe4ec66a578c"));
                            }
                            else if (bestMinSaturation < (255+backgroundWorstSaturation)/2) {
                                report.append(org.openpnp.Translations.getString("Local.520699a9352f6fbe"));
                            }
                            else {
                                report.append(org.openpnp.Translations.getString("Local.c71fd4844e8cd457"));
                            }
                        }
                    }
                    report.append("</html>");
                    ...
                    StringBuilder report = new StringBuilder();
                    report.append("<html>");
                    report.append(org.openpnp.Translations.getString("Local.0c486de3d49c2452"));
