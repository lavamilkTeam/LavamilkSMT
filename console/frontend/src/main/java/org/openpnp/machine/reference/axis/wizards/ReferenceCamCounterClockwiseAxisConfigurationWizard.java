...
public class ReferenceCamCounterClockwiseAxisConfigurationWizard extends AbstractAxisConfigurationWizard {
    ...
    public ReferenceCamCounterClockwiseAxisConfigurationWizard(AbstractMachine machine, ReferenceCamCounterClockwiseAxis axis) {
        ...
        panelTransformation.setBorder(new TitledBorder(null, org.openpnp.Translations.getString("Local.f6efc9fa8b4dba24"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        lblInputAxis = new JLabel(org.openpnp.Translations.getString("Local.4dffc6f89e3809d4"));
        ...
        inputAxis = new org.openpnp.gui.components.LocalizedComboBox(inputAxisModel);
        panelTransformation.add(inputAxis, "4, 2, fill, default");
        
        lblCamRadius = new JLabel(org.openpnp.Translations.getString("Local.dfcb93efa391b58f"));
        ...
        lblArmsAngle = new JLabel(org.openpnp.Translations.getString("Local.88465831db719bdf"));
        lblArmsAngle.setToolTipText(org.openpnp.Translations.getString("Local.4330613c8233342a"));
        ...
        lblCamWheelRadius = new JLabel(org.openpnp.Translations.getString("Local.cc5de833082ea24e"));
        ...
        lblDeprecated2 = new JLabel(org.openpnp.Translations.getString("Local.7aa81356689a37d1"));
        lblDeprecated2.setForeground(Color.RED);
        panelTransformation.add(lblDeprecated2, "6, 8, 1, 3");
        
        lblCamWheelGap = new JLabel(org.openpnp.Translations.getString("Local.7e4e0f67625e42c6"));
