...
public class ReferenceActuatorProfiles extends AbstractTableModel {
    ...
    public String actuate(Actuator actuator, String name) throws Exception {
        ...
        if (profile == null) {
            // None found.
            throw new Exception(org.openpnp.Translations.format("Local.f631957fa46e5ab9", (actuator), (name)));
        }
    ...
    public String actuate(Actuator actuator, boolean on) throws Exception { 
        ...
        if (profile == null) {
            // None found.
            throw new Exception(org.openpnp.Translations.format("Local.d2dede277c68b7ff", (actuator), ((on ? getColumnName(1) : getColumnName(2)))));
        }
        actuate(actuator, profile);
        return profile.getName();
    }
