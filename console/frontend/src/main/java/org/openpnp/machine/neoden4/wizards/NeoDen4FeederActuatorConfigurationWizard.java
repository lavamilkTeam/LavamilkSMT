...
public class NeoDen4FeederActuatorConfigurationWizard extends AbstractActuatorConfigurationWizard {
    ...
    protected void createUi(AbstractMachine machine) {
        ...
        panelProperties.setBorder(new TitledBorder(null, org.openpnp.Translations.getString("Local.ae43692b2a310b8e"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        lblDriver = new JLabel(org.openpnp.Translations.getString("Local.9fe4c68ec20dda7c"));
        panelProperties.add(lblDriver, "2, 2, right, default");
        
        driver = new org.openpnp.gui.components.LocalizedComboBox(new DriversComboBoxModel(machine, true));
        panelProperties.add(driver, "4, 2, fill, default");
        
        lblName = new JLabel(org.openpnp.Translations.getString("Local.dcd1d5223f73b3a9"));
        ...
        lblPeelerId = new JLabel(org.openpnp.Translations.getString("Local.d3bceea03dc0dad0"));
        ...
        lblFeederId = new JLabel(org.openpnp.Translations.getString("Local.db0ccc4ff48d161e"));
        ...
        lblFeedStrength = new JLabel(org.openpnp.Translations.getString("Local.1f8c71eb0db01483"));
        ...
        lblPeelStrength = new JLabel(org.openpnp.Translations.getString("Local.18af1366af241fd2"));
        ...
        lblFeedLength = new JLabel(org.openpnp.Translations.getString("Local.d282444aa2617562"));
        ...
        lblPeelLength = new JLabel(org.openpnp.Translations.getString("Local.05276a58d2c2a2bc"));
        ...
        lblChangeId = new JLabel(org.openpnp.Translations.getString("Local.dcb600fc321e777a"));
        panelProperties.add(lblChangeId, "2, 18, right, default");
        
        lblChangeIdNote = new JLabel(org.openpnp.Translations.getString("Local.210bf351cef0bd28"));
        panelProperties.add(lblChangeIdNote, "4, 18, center, default");
        
        newId = new org.openpnp.gui.components.LocalizedComboBox<Integer>();
        for(int i = 0; i <= 99; i++) {
            newId.addItem(i);        }

        lblNewText = new JLabel(org.openpnp.Translations.getString("Local.ed5a79a96b41d646"));
        panelProperties.add(lblNewText, "6, 18, right, default");
        
        panelProperties.add(newId, "8, 18, fill, default");
        
        btnChangeFeederIdAction = new JButton(new AbstractAction(org.openpnp.Translations.getString("Local.c0bf75bd78bf9572")) {
            @Override
