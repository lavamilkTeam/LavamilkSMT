...
public class Neoden4DriverConfigurationWizard extends AbstractConfigurationWizard {
    ...
    public Neoden4DriverConfigurationWizard(NeoDen4Driver driver) {
        ...
        panelMachineDetails.setBorder(new TitledBorder(null,
                org.openpnp.Translations.getString("Local.5247e8aa0d0534b2"), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
        ...
        JLabel lblHomeCoordinateX = new JLabel(org.openpnp.Translations.getString("Local.7ab8fff36d974cca"));
        ...
        JLabel lblHomeCoordinateY = new JLabel(org.openpnp.Translations.getString("Local.45d032173c161699"));
        ...
        JLabel lblScaleFactorX = new JLabel(org.openpnp.Translations.getString("Local.a1e74b9ee7820fc8"));
        ...
        JLabel lblScaleFactorY = new JLabel(org.openpnp.Translations.getString("Local.9bd871f2fb816300"));
