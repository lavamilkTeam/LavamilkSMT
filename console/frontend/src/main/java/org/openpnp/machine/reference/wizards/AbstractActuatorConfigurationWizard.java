...
public abstract class AbstractActuatorConfigurationWizard extends AbstractConfigurationWizard {
    ...
    protected void createUi(AbstractMachine machine) {
        ...
        axisX = new org.openpnp.gui.components.LocalizedComboBox<AxesComboBoxModel>(new AxesComboBoxModel(machine, AbstractAxis.class, Axis.Type.X, true));
        panelOffsets.add(axisX, "4, 4, fill, default");

        axisY = new org.openpnp.gui.components.LocalizedComboBox<AxesComboBoxModel>(new AxesComboBoxModel(machine, AbstractAxis.class, Axis.Type.Y, true));
        panelOffsets.add(axisY, "6, 4, fill, default");

        axisZ = new org.openpnp.gui.components.LocalizedComboBox<AxesComboBoxModel>(new AxesComboBoxModel(machine, AbstractAxis.class, Axis.Type.Z, true));
        panelOffsets.add(axisZ, "8, 4, fill, default");

        axisRotation = new org.openpnp.gui.components.LocalizedComboBox<AxesComboBoxModel>(new AxesComboBoxModel(machine, AbstractAxis.class, Axis.Type.Rotation, true));
        ...
        coordinatedBeforeActuate = new org.openpnp.gui.components.LocalizedComboBox<ActuatorCoordinationEnumType>(getCoordinatedBeforeActuateOptions());
        ...
        coordinatedAfterActuate = new org.openpnp.gui.components.LocalizedComboBox<ActuatorCoordinationEnumType>(getCoordinatedAfterActuateOptions());
        ...
        coordinatedBeforeRead = new org.openpnp.gui.components.LocalizedComboBox<ActuatorCoordinationEnumType>(getCoordinatedBeforeReadOptions());
        ...
        valueType = new org.openpnp.gui.components.LocalizedComboBox<Actuator.ActuatorValueType>(Actuator.ActuatorValueType.values());
        ...
        enabledActuation = new org.openpnp.gui.components.LocalizedComboBox<ReferenceActuator.MachineStateActuation>(ReferenceActuator.MachineStateActuation.values());
        generalPanel.add(enabledActuation, "4, 11, fill, default");
        
        homedActuation = new org.openpnp.gui.components.LocalizedComboBox<ReferenceActuator.MachineStateActuation>(ReferenceActuator.MachineStateActuation.values());
        generalPanel.add(homedActuation, "6, 11, fill, default");
        
        disabledActuation = new org.openpnp.gui.components.LocalizedComboBox<ReferenceActuator.MachineStateActuation>(ReferenceActuator.MachineStateActuation.values());
