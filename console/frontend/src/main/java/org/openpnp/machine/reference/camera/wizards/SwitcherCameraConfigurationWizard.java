...
public class SwitcherCameraConfigurationWizard extends AbstractConfigurationWizard {
    ...
    private void createUi() {
        ...
        lblNewLabel = new JLabel(org.openpnp.Translations.getString("Local.f66234c1f5de4f68"));
        contentPanel.add(lblNewLabel, "2, 2, right, default");
        
        sourceCamera = new org.openpnp.gui.components.LocalizedComboBox();
        contentPanel.add(sourceCamera, "4, 2, fill, default");
        
        lblNewLabel_1 = new JLabel(org.openpnp.Translations.getString("Local.2744ac40faa7a2eb"));
        ...
        lblNewLabel_2 = new JLabel(org.openpnp.Translations.getString("Local.7ceb75dce547812c"));
        ...
        lblNewLabel_4 = new JLabel(org.openpnp.Translations.getString("Local.40d252e74f2d5d94"));
        ...
        lblNewLabel_3 = new JLabel(org.openpnp.Translations.getString("Local.d0fffbc03877aabe"));
