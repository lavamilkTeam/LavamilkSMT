...
public class ReferenceNozzleTip extends AbstractNozzleTip {
    ...
    public static ReferenceNozzleTip getTemplateNozzleTip() throws Exception {
        ...
        throw new Exception(org.openpnp.Translations.getString("Local.430500558c956425"));
    }
    ...
    public Action loadAction = new AbstractAction(org.openpnp.Translations.getString("Local.8a6bdb6b18da586f")) {
        {
    ...
    public Action unloadAction = new AbstractAction(org.openpnp.Translations.getString("Local.6b88fe530b0a4bdd")) {
        {
    ...
    public Action deleteAction = new AbstractAction(org.openpnp.Translations.getString("Local.0731715ef31c2a1d")) {
        {
        ...
        if (location != null) {
            ...
            if (visionCalibrationOffset == null 
                ...
                if (getVisionTemplateImageEmpty() == null) {
                    throw new Exception(org.openpnp.Translations.format("Local.1778e82e39e6d8e4", (getName())));
                }
                if (getVisionTemplateImageOccupied() == null) {
                    throw new Exception(org.openpnp.Translations.format("Local.d836882e6120d7a1", (getName())));
                }
                    ...
                    for (int pass = 0; pass < visionCalibrationMaxPasses; ++pass) {
                        ...
                        if (Math.max(emptyMatch.maxVal, occupiedMatch.maxVal) < visionMatchMinimumScore) {
                            throw new Exception(String.format(
                                    org.openpnp.Translations.getString("Local.50f23a72039a6843"),
                        ...
                        if (foundOccupied != shouldBeOccupied) {
                            throw new Exception(String.format(
                                    org.openpnp.Translations.getString("Local.d505b96ac3829ad9"),
                        ...
                        if (location.getLinearLengthTo(nominalLocation)
                            ...
                            // Runaway? 
                            throw new Exception(org.openpnp.Translations.format("Local.9b4ecb2cf0228c5a", (getName())));
                        }
