...
public class GstreamerCameraConfigurationWizard extends AbstractConfigurationWizard {
    ...
    public GstreamerCameraConfigurationWizard(GstreamerCamera camera) {
        ...
        panelPipe.setBorder(
                new TitledBorder(null, org.openpnp.Translations.getString("Local.12453f0c5367d3e6"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
        panelPipe.setLayout(new FormLayout(
                new ColumnSpec[] { FormSpecs.RELATED_GAP_COLSPEC, FormSpecs.DEFAULT_COLSPEC,
                        FormSpecs.RELATED_GAP_COLSPEC, ColumnSpec.decode("default:grow"), },
                new RowSpec[] { FormSpecs.RELATED_GAP_ROWSPEC, FormSpecs.DEFAULT_ROWSPEC, }));

        JLabel lblPipeline = new JLabel(org.openpnp.Translations.getString("Local.56b4ec05bac3773b"));
