...
public class OnvifIPCameraConfigurationWizard extends AbstractConfigurationWizard {
    ...
    public OnvifIPCameraConfigurationWizard(OnvifIPCamera camera) {
        ...
        lblIP = new JLabel(org.openpnp.Translations.getString("Local.5613c06e5cd69225"));
        ...
        lbluseFor_ip = new JLabel(org.openpnp.Translations.getString("Local.1f8779f541db3fbb"));
        panelGeneral.add(lbluseFor_ip, "6, 2");

        lblUsername = new JLabel(org.openpnp.Translations.getString("Local.e3b89e9d33f88e52"));
        ...
        lbluseFor_un = new JLabel(org.openpnp.Translations.getString("Local.c0c7beddcd3b23db"));
        panelGeneral.add(lbluseFor_un, "6, 4");

        lblPassword = new JLabel(org.openpnp.Translations.getString("Local.e7cf3ef4f17c3999"));
        ...
        lbluseFor_pw = new JLabel(org.openpnp.Translations.getString("Local.f17d9c63fd4b83ed"));
        panelGeneral.add(lbluseFor_pw, "6, 6");

        lblSupportedResolutions = new JLabel(org.openpnp.Translations.getString("Local.d4055fafa3794fa8"));
        panelGeneral.add(lblSupportedResolutions, "2, 8, right, default");

        cboSupportedResolutions = new org.openpnp.gui.components.LocalizedComboBox<String>();
        refreshResolutionList();
        panelGeneral.add(cboSupportedResolutions, "4, 8, fill, default");

        lbluseFor_res = new JLabel(org.openpnp.Translations.getString("Local.07da26b25d44bc33"));
        panelGeneral.add(lbluseFor_res, "6, 8");

        lblResizeWidth = new JLabel(org.openpnp.Translations.getString("Local.bc667403a8dbaba8"));
        ...
        lbluseFor_rw = new JLabel(org.openpnp.Translations.getString("Local.2e40320d0dd0505f"));
        panelGeneral.add(lbluseFor_rw, "6, 10");

        lblResizeHeight = new JLabel(org.openpnp.Translations.getString("Local.469a9d28c4c87005"));
        ...
        lbluseFor_rh = new JLabel(org.openpnp.Translations.getString("Local.2e40320d0dd0505f"));
