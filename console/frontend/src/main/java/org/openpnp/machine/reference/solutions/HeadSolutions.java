...
public class HeadSolutions implements Solutions.Subject {
    ...
    protected void perNozzleSolutions(Solutions solutions, Nozzle nozzle) {
        ...
        if (nozzle.getAxisZ() == null) {
            solutions.add(new Solutions.PlainIssue(
                    nozzle, 
                    org.openpnp.Translations.message("Local.6554df08bd0d1920", (nozzle.getName())), 
                    org.openpnp.Translations.message("Local.0ae8b3bc63385060"), 
                    Severity.Error,
        ...
        if (nozzle.getAxisRotation() == null) {
            solutions.add(new Solutions.PlainIssue(
                    nozzle, 
                    org.openpnp.Translations.message("Local.be5f50660d4f8fbc", (nozzle.getName())), 
                    org.openpnp.Translations.message("Local.452b496da9b7ad2f"), 
                    Severity.Error,
                    "https://github.com/openpnp/openpnp/wiki/Mapping-Axes"));
        }
        if (nozzle.getAxisZ() != null && nozzle.getAxisRotation() != null) {
            ...
            for (Nozzle nozzle2 : head.getNozzles()) {
                ...
                if (nozzle2.getAxisZ() == nozzle.getAxisZ()) {
                    solutions.add(new Solutions.PlainIssue(
                            nozzle, 
                            org.openpnp.Translations.message("Local.197035c59377cee3", (nozzle2.getName()), (nozzle.getName())), 
                            org.openpnp.Translations.message("Local.00757b72cc92b4d1"), 
                            Severity.Error,
                            "https://github.com/openpnp/openpnp/wiki/Mapping-Axes"));
                }
                if (nozzle2.getAxisRotation() == nozzle.getAxisRotation()) {
                    solutions.add(new Solutions.PlainIssue(
                            nozzle, 
                            org.openpnp.Translations.message("Local.9631eb08e7fec2db", (nozzle2.getName()), (nozzle.getName())), 
                            org.openpnp.Translations.message("Local.b56e7f97250eb043"), 
    ...
    protected void sameAxisAssignedIssue(Solutions solutions, Camera camera, HeadMountable hm,
        ...
        solutions.add(new Solutions.Issue(
                head, 
                org.openpnp.Translations.message("Local.f32b29a30e52b09d", (camera.getName()), (hm.getName()), (type), (axis.getName())), 
                org.openpnp.Translations.message("Local.7078c3c70ec11513", (type), (axis.getName()), (camera.getName())),
                Severity.Error,
    ...
    protected void addMissingAxisIssue(Solutions solutions, final HeadMountable hm, Axis.Type type) {
        ...
        solutions.add(new Solutions.Issue(
                hm, 
                (oldAxis == null ? org.openpnp.Translations.message("Local.82e3408143bb631e", (type.name())) : org.openpnp.Translations.message("Local.e4a7a75642354534", (oldAxis.getClass().getSimpleName()), (oldAxis.getName()), (type.name()))), 
                (axis == null ? org.openpnp.Translations.message("Local.2579b7a84128f199", (type.name())) : org.openpnp.Translations.message("Local.d5cd98a43fb0471a", ((isNew ? org.openpnp.Translations.message("Local.e7033ec1968cacb6") : org.openpnp.Translations.message("Local.4d4b3ff2cd377148"))), (axis.getClass().getSimpleName()), (axis.getName()), (type.name()))), 
    ...
    protected void addInconsistentAxisIssue(Solutions solutions, final Camera camera,
        ...
        if ((hm instanceof Nozzle || oldAxis != null) 
            ...
            solutions.add(new Solutions.Issue(
                    hm, 
                    org.openpnp.Translations.message("Local.60d80c9d31bf2af3", (type.name()), ((oldAxis != null ? oldAxis.getName() : "null")), (camera.getName())), 
                            org.openpnp.Translations.message("Local.51990fde6fac3370", (camera.getAxis(type).getName()), (type.name())), 
