...
public class VisionSolutions implements Solutions.Subject {
        ...
        if (solutions.isTargeting(Milestone.Production)) {
            if (Configuration.get().getTablesLinked() == TablesLinked.Unlinked) {
                solutions.add(new Solutions.Issue(
                        machine, 
                        org.openpnp.Translations.message("Local.72f7572b14807de8"), 
                        org.openpnp.Translations.message("Local.830b1b1c22e4b5b0"), 
                        Severity.Suggestion,
    ...
    public class VisionFeatureIssue extends Solutions.Issue {
        ...
        public VisionFeatureIssue(Subject subject, ReferenceCamera camera, Length featureDiameterIfKnown, Object issue, Object solution, Severity severity, String uri) {
        ...
        public Solutions.Issue.CustomProperty[] getProperties() {
            ...
            return new Solutions.Issue.CustomProperty[] {
                    new Solutions.Issue.IntegerProperty(
                            org.openpnp.Translations.format("Local.db975c26e72d1410"),
                            org.openpnp.Translations.format("Local.d10e5d042b9cc0ba"),
                            3, maxDiameter) {
                        @Override
                        public int get() {
                    ...
                    new Solutions.Issue.ActionProperty( 
                            "", org.openpnp.Translations.format("Local.12d8b39374560e06")) {
                        @Override
                        public Action get() {
                            return new AbstractAction(org.openpnp.Translations.getString("Local.412072f2ab026e31"), Icons.rotateCounterclockwise) {
                                @Override
            ...
            if (camera.getLooking() == Looking.Up) {
                return new Solutions.Issue.Choice[]{
                    new Solutions.Issue.Choice(true,  
                                      org.openpnp.Translations.format("Local.aeec1c9dcb85aaf5"), 
                                    null), 
                    new Solutions.Issue.Choice(false,  
                                      org.openpnp.Translations.format("Local.f3cd6ec96dd9ea6d"), 
                                    null), 
                };
            } else {
                return new Solutions.Issue.Choice[] {};
    ...
    private void perDownLookingCameraSolutions(Solutions solutions, ReferenceHead head, Camera defaultCamera, Nozzle defaultNozzle, ReferenceCamera camera) {
        ...
        if (camera == defaultCamera) {
            ...
            solutions.add(new VisionFeatureIssue(
                    ...
                    camera,
                    oldFiducialDiameter,
                    org.openpnp.Translations.message("Local.d5820823e953700a"), 
                    org.openpnp.Translations.message("Local.4391280eb9b742a7"), 
                ...
                public String getExtendedDescription() {
                    return org.openpnp.Translations.format("Local.1e53bdc91c14f83c", (camera.getName()));
                }
            ...
            solutions.add(new VisionFeatureIssue(
                    ...
                    org.openpnp.Translations.message("Local.2e032f88412e8bf2"), 
                    org.openpnp.Translations.message("Local.866ab7a17b8f1095"), 
                    Solutions.Severity.Fundamental,
                ...
                @Override 
                public String getExtendedDescription() {
                    return org.openpnp.Translations.format("Local.c1ab66ec4a73b30f", (camera.getName()));
                }
            ...
            solutions.add(new VisionFeatureIssue(
                    ...
                    org.openpnp.Translations.message("Local.0a3b909f8c4c6e53"), 
                    org.openpnp.Translations.message("Local.2addfb20acd1f887", (camera.getName())), 
                    Solutions.Severity.Fundamental,
                ...
                @Override 
                public String getExtendedDescription() {
                    return org.openpnp.Translations.format("Local.13cee50b19a9e40f", (camera.getName()));
                }
                ...
                public void setState(Solutions.State state) throws Exception {
                    if (state == State.Solved) {
                        if (! isSolvedPrimaryXY(head)) {
                            throw new Exception(org.openpnp.Translations.format("Local.1f631ce220104240", (head.getName())));
                        }
    ...
    private void perUpLookingCameraSolutions(Solutions solutions, ReferenceHead head, 
        ...
        if (isSolvedPrimaryXY(head) && isSolvedPrimaryZ(head)
            ...
            solutions.add(new VisionFeatureIssue(
                    ...
                    camera,
                    oldVisionDiameter,
                    org.openpnp.Translations.message("Local.54b1d3b89a3d654b", (camera.getName())), 
                    org.openpnp.Translations.message("Local.7a7acc57ef1561de", (defaultNozzle.getName()), (camera.getName())), 
                    Solutions.Severity.Fundamental,
                ...
                @Override 
                public String getExtendedDescription() {
                    return org.openpnp.Translations.format("Local.8f2578892fac8bc4", (defaultNozzle.getName()), (defaultNozzle.getName()), (camera.getName()));
                }
                ...
                public void setState(Solutions.State state) throws Exception {
                    if (state == State.Solved) {
                        if (! (defaultNozzle.getHeadOffsets().isInitialized() || camera instanceof SimulatedUpCamera)) {
                            throw new Exception(org.openpnp.Translations.format("Local.d2d4102efedb13a9", (defaultNozzle.getName()), (defaultNozzle.getName())));
                        }
                        ...
                        if (referenceNozzleTip == null) {
                            throw new Exception(org.openpnp.Translations.format("Local.84e92309f0be215c", (defaultNozzle.getName())));
                        }
        ...
        if (isSolvedPrimaryXY(head) 
            ...
            if (defaultNozzle == nozzle
                ...
                solutions.add(new Solutions.PlainIssue(
                        head, 
                        org.openpnp.Translations.message("Local.893c7a6186507e5f"), 
                        org.openpnp.Translations.message("Local.942ed544bf42fbad", (head.getName()), (fiducialsMinimumZOffsetMm)), 
            ...
            for (boolean primary : (nozzle == defaultNozzle && isSolvedSecondaryXY(head)) ? new boolean [] {true, false} : new boolean [] {true} ) {
                ...
                if (defaultNozzle == nozzle
                    ...
                    solutions.add(new Solutions.PlainIssue(
                            nozzle, 
                            org.openpnp.Translations.message("Local.30a4bf1634f3e79a", (nozzle.getName()), (qualifier)), 
                            org.openpnp.Translations.message("Local.069a7c25a6aff023", (nozzle.getName()), (qualifier), (qualifier)), 
                            Solutions.Severity.Error,
                            "https://github.com/openpnp/openpnp/wiki/Vision-Solutions#nozzle-offsets"));
                }
                solutions.add(new Solutions.Issue(
                        nozzle, 
                        org.openpnp.Translations.message("Local.1ae003aff516a311", (nozzle.getName()), (qualifier)), 
                        org.openpnp.Translations.message("Local.636e4abe474359ec", (nozzle.getName()), (qualifier)), 
                        Solutions.Severity.Fundamental,
                        "https://github.com/openpnp/openpnp/wiki/Vision-Solutions#nozzle-offsets") {
                    ...
                    @Override 
                    public String getExtendedDescription() {
                        return org.openpnp.Translations.format("Local.2642370acb107b6b", (qualifier), (((nozzle == defaultNozzle) ? 
                                        org.openpnp.Translations.getString("Local.8bd468710b24a3e2")+qualifier+org.openpnp.Translations.getString("Local.6beaa20bf5a0181c") : 
                                            org.openpnp.Translations.getString("Local.e5f7012fcfee238c")+nozzle.getName()+org.openpnp.Translations.getString("Local.4e37fc271f5a3324")+defaultNozzle.getName()+".</p><br/>")), ((isNonZeroReferenceZOffset ?
                                        org.openpnp.Translations.getString("Local.4765fb3b16769321")+nozzle.getName()+org.openpnp.Translations.getString("Local.6416fc339a802c67") : 
                                        "")), (nozzle.getName()), (qualifier));
                    }
                    ...
                    public void setState(Solutions.State state) throws Exception {
                        if (state == State.Solved) {
                            ...
                            if (nozzle.getSafeZ() == null) {
                                throw new Exception(org.openpnp.Translations.format("Local.f7dcd782fc73961d", (nozzle.getName())));
                            }
                            if (! isSolvedPrimaryXY(head)) {
                                throw new Exception(org.openpnp.Translations.format("Local.1f631ce220104240", (head.getName())));
                            }
                            if (! (defaultNozzle == nozzle || isSolvedPrimaryZ(head))) {
                                throw new Exception(org.openpnp.Translations.format("Local.9d571557e74fabd8", (head.getName())));
                            }
                            if (!primary) {
                                if (! isSolvedSecondaryXY(head)) {
                                    throw new Exception(org.openpnp.Translations.format("Local.95bce41423ca194f", (head.getName())));
                                }
                            }
                            final State oldState = getState();
                            UiUtils.submitUiMachineTask(
                                    () -> {
                                        ...
                                        if (nozzle == defaultNozzle) {
                                            ...
                                            if (nozzle.getSafeZ().compareTo(nozzleLocation.getLengthZ()) <= 0) {
                                                throw new Exception(org.openpnp.Translations.format("Local.70258cc66f281188", (qualifier)));
                                            }
                                            else if (!primary
                                                    && Math.abs(head.getCalibrationPrimaryFiducialLocation().getLengthZ()
                                                    .subtract(nozzleLocation.getLengthZ())
                                                    .convertToUnits(LengthUnit.Millimeters).getValue()) < fiducialsMinimumZOffsetMm) {
                                                throw new Exception(org.openpnp.Translations.format("Local.1a995c1fc4936c3a", (fiducialsMinimumZOffsetMm)));
                                            }
                                            if (primary) {
                                                head.setCalibrationPrimaryFiducialLocation(head.getCalibrationPrimaryFiducialLocation()
    ...
    private void perHeadSolutions(Solutions solutions, ReferenceHead head, ReferenceCamera defaultCamera) {
        ...
        if (defaultCamera.getUnitsPerPixelPrimary().isInitialized()
            ...
            solutions.add(new VisionFeatureIssue(
                    ...
                    defaultCamera,
                    oldFiducialDiameter,
                    org.openpnp.Translations.message("Local.8958a436c8dc04cf"), 
                    org.openpnp.Translations.message("Local.670b105465f68670"), 
                ...
                @Override 
                public String getExtendedDescription() {
                    return org.openpnp.Translations.format("Local.79aaa8e5c12af244", (defaultCamera.getName()));
                }
                ...
                public void setState(Solutions.State state) throws Exception {
                    if (state == State.Solved) {
                        if (! defaultCamera.getUnitsPerPixelPrimary().isInitialized()) {
                            throw new Exception(org.openpnp.Translations.format("Local.45671049fd544955", (defaultCamera.getName())));
                        }
                        final State oldState = getState();
                        UiUtils.submitUiMachineTask(
                                () -> {
    ...
    public Length autoCalibrateCamera(ReferenceCamera camera, HeadMountable movable, Double expectedDiameter, String diagnostics, boolean secondary, boolean autoFocus) 
        ...
        if (camera.getAdvancedCalibration().isOverridingOldTransformsAndDistortionCorrectionSettings()) {
            throw new Exception(org.openpnp.Translations.format("Local.93246ae935d2ea1e", (camera.getName())));
        }
        ...
        try {
            ...
            for (int pass = 0; pass < 3; pass++) {
                ...
                if (pass > 0) {
                    if (!confirmed) {
                        throw new Exception(org.openpnp.Translations.getString("Local.c11e99c453d68bc7"));
                    }
    ...
    private Circle getPixelLocationShot(ReferenceCamera camera, String diagnostics, Mat image,
        ...
        if (results.size() < 1) {
            throw new Exception(org.openpnp.Translations.getString("Local.e239f306f989239d"));
        }
