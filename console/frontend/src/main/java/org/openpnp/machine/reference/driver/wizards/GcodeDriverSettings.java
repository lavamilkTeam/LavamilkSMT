...
public class GcodeDriverSettings extends AbstractConfigurationWizard {
    ...
    public GcodeDriverSettings(GcodeDriver driver) {
        ...
        motionControlType = new org.openpnp.gui.components.LocalizedComboBox(MotionControlType.values());
        ...
        unitsCb = new org.openpnp.gui.components.LocalizedComboBox(LengthUnit.values());
