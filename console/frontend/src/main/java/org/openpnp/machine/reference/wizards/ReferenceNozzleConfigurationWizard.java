...
public class ReferenceNozzleConfigurationWizard extends AbstractConfigurationWizard {
    ...
    public ReferenceNozzleConfigurationWizard(AbstractMachine machine, ReferenceNozzle nozzle) {
        ...
        axisX = new org.openpnp.gui.components.LocalizedComboBox(new AxesComboBoxModel(machine, AbstractAxis.class, Axis.Type.X, true));
        panelOffsets.add(axisX, "4, 4, fill, default");

        axisY = new org.openpnp.gui.components.LocalizedComboBox(new AxesComboBoxModel(machine, AbstractAxis.class, Axis.Type.Y, true));
        panelOffsets.add(axisY, "6, 4, fill, default");

        axisZ = new org.openpnp.gui.components.LocalizedComboBox(new AxesComboBoxModel(machine, AbstractAxis.class, Axis.Type.Z, true));
        panelOffsets.add(axisZ, "8, 4, fill, default");

        axisRotation = new org.openpnp.gui.components.LocalizedComboBox(new AxesComboBoxModel(machine, AbstractAxis.class, Axis.Type.Rotation, true));
        ...
        rotationMode = new org.openpnp.gui.components.LocalizedComboBox(RotationMode.values());
