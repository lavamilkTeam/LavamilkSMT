...
public class ReferenceHeapFeeder extends ReferenceFeeder {
    ...
    public void feed(Nozzle nozzle) throws Exception {       
        ...
        for (int attempt = 0; attempt <= maxThrowRetries; attempt++) {
            ...
            if (!dropBox.tryToFlipSomePart(nozzle)) {
                if (lastRoundPartsFetched == true) {
                    throw new Exception(org.openpnp.Translations.format("Local.afb12fc6f58440be", (getName())));
                } else {
        ...
        if (pickLocation == null) {
            throw new Exception(org.openpnp.Translations.format("Local.2464b9f7ba598b9c", (getName())));
        }
    }
    ...
    private double pokeForParts(Nozzle nozzle, double vacuumLevel) throws Exception {
        ...
        if (currentDepth <= (boxDepth + part.getHeight().getValue())) {
            throw new Exception(org.openpnp.Translations.format("Local.b3411feecfcc7582", (getName())));
        }
        // if moved too much into parts => failed
        if (currentDepth <= (lastFeedDepth - 3 * part.getHeight().getValue()) && lastFeedDepth != 0) {
            throw new Exception(org.openpnp.Translations.format("Local.f8a1f76250f991b3", (getName())));
        }
        return currentDepth;
    }
    ...
    public void setDropBox(DropBox dropBox) throws Exception {
        if (dropBox == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.793d9e8513e6e29d"));
        }
    ...
    public void setDropBoxLocation(Location dropBox) throws Exception {
        if (dropBox == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.e56d59f2201254ae"));
        }
    ...
    public static class DropBox extends AbstractModelObject implements Identifiable, Named {
        ...
        public void clean(Nozzle nozzle) throws Exception {
            ...
            throw new Exception(org.openpnp.Translations.format("Local.68a73fc05cb0b59e", (getName()), (maxAttempts)));
        }
            ...
            try (CvPipeline pipeline = getPartPipeline()) {
                ...
                if (partLocation != null) {
                    ...
                    if (partLocation != null) {
                        ...
                        throw new Exception(org.openpnp.Translations.format("Local.481b6c4b26882d50", (getName())));
                    }
                }
                MainFrame.get()
                .getCameraViews()
    ...
    public static class HeapFeederHelper {
        ...
        static void dropPart(Nozzle nozzle, Location location) throws Exception {
            ...
            if (!nozzle.isPartOff()) {
                throw new Exception(org.openpnp.Translations.getString("Local.46417d3ec61da0bd"));
            }
        }
