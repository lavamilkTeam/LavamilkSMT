        ...
        if (solutions.isTargeting(Milestone.Kinematics)) {
            if (! machine.isHomed()) {
                solutions.add(new Solutions.Issue(
                        machine, 
                        org.openpnp.Translations.message("Local.2988cdc0d384cb62"), 
                        org.openpnp.Translations.message("Local.fdbff3488a6377a1"),
                        Severity.Fundamental,
                        "https://github.com/openpnp/openpnp/wiki/User-Manual#machine-controls") {

                    @Override 
                    public String getExtendedDescription() {
                        return org.openpnp.Translations.format("Local.fe5b4b7332d5b362");
                    }
                ...
                for (Nozzle nozzle : head.getNozzles()) {
                    if (nozzle instanceof ReferenceNozzle) {
                        ...
                        Issue issue = new Solutions.Issue(
                                nozzle, 
                                org.openpnp.Translations.message("Local.7fcf3e2f1cf81823", (nozzle.getName())), 
                                org.openpnp.Translations.message("Local.35ba71f4c867f9b8", (nozzle.getName())), 
                            ...
                            public Solutions.Issue.Choice[] getChoices() {
                                return new Solutions.Issue.Choice[] {
                                        new Solutions.Issue.Choice(true, 
                                                org.openpnp.Translations.format("Local.a31c3f9d7684ce62"),
                                                        Icons.safeZDynamic),
                                        new Solutions.Issue.Choice(false, 
                                                org.openpnp.Translations.format("Local.a875299be7bf3986"),
                                                        Icons.safeZFixed),
                                };
                            }
                            ...
                            if (axisZ.getDriver() != null) {
                                try {
                                    ...
                                    if (bothSafeZoneHighAndLowEnabled
                                        ...
                                        solutions.add(new Solutions.Issue(
                                                axisZ, 
                                                org.openpnp.Translations.message("Local.6052fe399113936c", (axisZ.getName())), 
                                                org.openpnp.Translations.message("Local.b46cc9bf81019d16", (axisZ.getName())), 
                                        ...
                                        if (bothSafeZoneHighAndLowEnabled
                                            ...
                                            solutions.add(new Solutions.PlainIssue(
                                                    hm,
                                                    org.openpnp.Translations.message("Local.c3496fd4b855f1a0", (hm.getName())),
                                                    org.openpnp.Translations.message("Local.757064120f3a2949", (hm.getName())),
                                        ...
                                        safeZSolved = solutions.add(new Solutions.Issue(
                                                hm, 
                                                org.openpnp.Translations.message("Local.99a8a48bd9a25e59", (hm.getName())), 
                                                org.openpnp.Translations.message("Local.e6c489d3c59c275a", (hm.getName())), 
                                                Solutions.Severity.Fundamental,
                                            ...
                                            @Override 
                                            public String getExtendedDescription() {
                                                return org.openpnp.Translations.format("Local.3142008c04cffe6e", (hm.getName()), ((partClearance ? org.openpnp.Translations.getString("Local.176d2f44ae29db12") : "")), ((head.getNozzles().size() > 1 ? 
                                                                org.openpnp.Translations.getString("Local.281878c0391ed02e"):
                                                            "")));
                                            }
            ...
            for (Axis axis : machine.getAxes()) {
                if (axis instanceof ReferenceCamClockwiseAxis
                    ...
                    if (oldCamWheelRadius.getValue() != 0 || oldCamWheelGap.getValue() != 0) {
                        solutions.add(new Solutions.Issue(
                                cam1Axis, 
                                org.openpnp.Translations.message("Local.f63c010623ca0b52", (cam1Axis.getName())), 
                                org.openpnp.Translations.message("Local.2a48327adc476ce6", (cam1Axis.getName()), ((oldCamWheelRadius.getValue() != 0 ? "wheel radius, " : "")), ((oldCamWheelGap.getValue() != 0 ? "wheel gap, " : ""))), 
                                Solutions.Severity.Warning,
                                "https://github.com/openpnp/openpnp/wiki/Transformed-Axes#referencecamcounterclockwiseaxis") {

                            @Override 
                            public String getExtendedDescription() {
                                return org.openpnp.Translations.format("Local.69aead42133c5860", (cam1Axis.getName()), ((oldCamWheelRadius.getValue() != 0 ? org.openpnp.Translations.getString("Local.1da058b653fa6327") : "")), ((oldCamWheelGap.getValue() != 0 ? org.openpnp.Translations.getString("Local.9a75fcc3b8f61e6f") : "")), ((oldCamWheelRadius.getValue() != 0 ? org.openpnp.Translations.getString("Local.1da058b653fa6327") : "")), ((oldCamWheelGap.getValue() != 0 ? org.openpnp.Translations.getString("Local.9a75fcc3b8f61e6f") : "")), ((hm1 != null || hm2 != null ?
                                                        org.openpnp.Translations.getString("Local.c50627e247deeda5")
                                                        + (hm1 != null ? hm1.getClass().getSimpleName()+" "+hm1.getName()+", " : "")
                                                        + (hm2 != null ? hm2.getClass().getSimpleName()+" "+hm2.getName()+", " : "")
                                                        + org.openpnp.Translations.getString("Local.71ccaf6323d321c6"):
                                                        "")));
                            }
                    ...
                    if (hm != null) {
                        ...
                        for (boolean limitLow : new Boolean[] {true, false}) {
                            ...
                            if (!(limitLow ? controllerAxis.isSoftLimitLowEnabled() : controllerAxis.isSoftLimitHighEnabled())) {
                                solutions.add(new Solutions.Issue(
                                        controllerAxis, 
                                        org.openpnp.Translations.message("Local.03119ea32f8834d3", (qualifier), (controllerAxis.getName())), 
                                        org.openpnp.Translations.message("Local.50aa4285fb7051df", (controllerAxis.getName()), (qualifier)), 
                                    ...
                                    @Override 
                                    public String getExtendedDescription() {
                                        return org.openpnp.Translations.format("Local.cf73e316f7e0a232", (controllerAxis.getName()), (qualifier), (controllerAxis.getType().getDefaultLetter()), (hm.getClass().getSimpleName()), (hm.getName()));
                                    }
            ...
            for (NozzleTip nt : nozzle.getCompatibleNozzleTips()) {
                if (nt instanceof ReferenceNozzleTip) {
                    ...
                    if (signum2*signum1 == -1) {
                        solutions.add(new Solutions.PlainIssue(
                                nt, 
                                org.openpnp.Translations.message("Local.0187fc9a89970469", (nozzle.getName()), (nt.getName())), 
                                org.openpnp.Translations.message("Local.d0727f5e7b4e3133", (rawAxisZ.getName())), 
                                Severity.Error,
                                "https://github.com/openpnp/openpnp/wiki/Kinematic-Solutions#dynamic-safe-z-zone") {

                                    @Override
                                    public String getExtendedDescription() {
                                        return org.openpnp.Translations.format("Local.91c52f1f77ae3fd6", (nozzle.getName()), (nt.getName()), (lengthConverter.convertForward(maxHeight)), (lengthConverter.convertForward(zone)), (rawAxisZ.getName()), (lengthConverter.convertForward(rawAxisZ.getSafeZoneLow())), (lengthConverter.convertForward(rawAxisZ.getSafeZoneHigh())), (nozzle.getName()), (nt.getName()), (nozzle.getName()), (nozzle.getName()));
                                    }
                                    @Override
                                    public Icon getExtendedIcon() {
                        ...
                        if (nt2 != null) {
                            ...
                            if (signum3*signum1 == -1) {
                                solutions.add(new Solutions.PlainIssue(
                                        nt, 
                                        org.openpnp.Translations.message("Local.8a2f07a6806e705e", (nozzle.getName()), (nt.getName()), (nozzle2.getName()), (nt2.getName())), 
                                        org.openpnp.Translations.message("Local.e505ccf71f8452c8", (rawAxisZ.getName())), 
                                        Severity.Warning,
                                        "https://github.com/openpnp/openpnp/wiki/Kinematic-Solutions#dynamic-safe-z-zone") {

                                    @Override
                                    public String getExtendedDescription() {
                                        return org.openpnp.Translations.format("Local.bbd3df828b6c18eb", (nozzle.getName()), (nt.getName()), (lengthConverter.convertForward(maxHeight)), (nozzle2.getName()), (nt2.getName()), (lengthConverter.convertForward(maxHeight2)), (lengthConverter.convertForward(zone)), (rawAxisZ.getName()), (lengthConverter.convertForward(rawAxisZ.getSafeZoneLow())), (lengthConverter.convertForward(rawAxisZ.getSafeZoneHigh())), (nozzle.getName()), (nozzle2.getName()), (nt.getName()), (nt2.getName()), (nozzle.getName()), (nozzle2.getName()), (nozzle2.getName()));
                                    }
                                    @Override
                                    public Icon getExtendedIcon() {
                                        return Icons.safeZDynamic;
