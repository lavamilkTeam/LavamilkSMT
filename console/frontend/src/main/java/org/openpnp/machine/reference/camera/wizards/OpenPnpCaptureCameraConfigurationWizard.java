...
public class OpenPnpCaptureCameraConfigurationWizard extends AbstractConfigurationWizard {
    ...
    private void createUi() {
        ...
        panelGeneral.setLayout(new FormLayout(new ColumnSpec[] {
            ...
            new RowSpec[] {
                ...
                panelGeneral.add(lblDevice, "2, 2, right, default");
                        ...
                        deviceCb = new org.openpnp.gui.components.LocalizedComboBox();
                        panelGeneral.add(deviceCb, "4, 2");
                                ...
                                panelGeneral.add(lblFormat, "2, 4, right, default");
                                        ...
                                        formatCb = new org.openpnp.gui.components.LocalizedComboBox();
        ...
        brightnessMin = new JLabel(org.openpnp.Translations.getString("Local.1f6fa6f69d185e60"));
        ...
        brightnessMax = new JLabel(org.openpnp.Translations.getString("Local.9baf3a40312f3984"));
        panelProperties.add(brightnessMax, "18, 4");

        brightnessDefault = new JLabel(org.openpnp.Translations.getString("Local.cb8379ac2098aa16"));
        ...
        backLightCompensationMin = new JLabel(org.openpnp.Translations.getString("Local.1f6fa6f69d185e60"));
        ...
        backLightCompensationMax = new JLabel(org.openpnp.Translations.getString("Local.9baf3a40312f3984"));
        panelProperties.add(backLightCompensationMax, "18, 6");
        
        backLightCompensationDefault = new JLabel(org.openpnp.Translations.getString("Local.cb8379ac2098aa16"));
        ...
        contrastMin = new JLabel(org.openpnp.Translations.getString("Local.1f6fa6f69d185e60"));
        ...
        contrastMax = new JLabel(org.openpnp.Translations.getString("Local.9baf3a40312f3984"));
        panelProperties.add(contrastMax, "18, 8");

        contrastDefault = new JLabel(org.openpnp.Translations.getString("Local.cb8379ac2098aa16"));
        ...
        exposureMin = new JLabel(org.openpnp.Translations.getString("Local.1f6fa6f69d185e60"));
        ...
        exposureMax = new JLabel(org.openpnp.Translations.getString("Local.9baf3a40312f3984"));
        panelProperties.add(exposureMax, "18, 10, center, default");

        exposureDefault = new JLabel(org.openpnp.Translations.getString("Local.cb8379ac2098aa16"));
        panelProperties.add(exposureDefault, "22, 10");

        focusDefault = new JLabel(org.openpnp.Translations.getString("Local.cb8379ac2098aa16"));
        panelProperties.add(focusDefault, "22, 12");

        gainDefault = new JLabel(org.openpnp.Translations.getString("Local.cb8379ac2098aa16"));
        ...
        gammaMin = new JLabel(org.openpnp.Translations.getString("Local.1f6fa6f69d185e60"));
        ...
        gammaMax = new JLabel(org.openpnp.Translations.getString("Local.9baf3a40312f3984"));
        panelProperties.add(gammaMax, "18, 16");

        gammaDefault = new JLabel(org.openpnp.Translations.getString("Local.cb8379ac2098aa16"));
        ...
        hueMin = new JLabel(org.openpnp.Translations.getString("Local.1f6fa6f69d185e60"));
        ...
        hueMax = new JLabel(org.openpnp.Translations.getString("Local.9baf3a40312f3984"));
        panelProperties.add(hueMax, "18, 18");
        
        hueDefault = new JLabel(org.openpnp.Translations.getString("Local.cb8379ac2098aa16"));
        ...
        powerLineFrequencyMin = new JLabel(org.openpnp.Translations.getString("Local.1f6fa6f69d185e60"));
        ...
        powerLineFrequencyMax = new JLabel(org.openpnp.Translations.getString("Local.9baf3a40312f3984"));
        panelProperties.add(powerLineFrequencyMax, "18, 20");
        
        powerLineFrequencyDefault = new JLabel(org.openpnp.Translations.getString("Local.cb8379ac2098aa16"));
        ...
        saturationMin = new JLabel(org.openpnp.Translations.getString("Local.1f6fa6f69d185e60"));
        ...
        saturationMax = new JLabel(org.openpnp.Translations.getString("Local.9baf3a40312f3984"));
        panelProperties.add(saturationMax, "18, 22");

        saturationDefault = new JLabel(org.openpnp.Translations.getString("Local.cb8379ac2098aa16"));
        ...
        sharpnessMin = new JLabel(org.openpnp.Translations.getString("Local.1f6fa6f69d185e60"));
        ...
        sharpnessMax = new JLabel(org.openpnp.Translations.getString("Local.9baf3a40312f3984"));
        panelProperties.add(sharpnessMax, "18, 24");
        
        sharpnessDefault = new JLabel(org.openpnp.Translations.getString("Local.cb8379ac2098aa16"));
        ...
        whiteBalanceMin = new JLabel(org.openpnp.Translations.getString("Local.1f6fa6f69d185e60"));
        ...
        whiteBalanceMax = new JLabel(org.openpnp.Translations.getString("Local.9baf3a40312f3984"));
        ...
        focusMin = new JLabel(org.openpnp.Translations.getString("Local.1f6fa6f69d185e60"));
        ...
        focusMax = new JLabel(org.openpnp.Translations.getString("Local.9baf3a40312f3984"));
        panelProperties.add(focusMax, "18, 12, center, default");

        whiteBalanceDefault = new JLabel(org.openpnp.Translations.getString("Local.cb8379ac2098aa16"));
        ...
        zoomMin = new JLabel(org.openpnp.Translations.getString("Local.1f6fa6f69d185e60"));
        ...
        zoomMax = new JLabel(org.openpnp.Translations.getString("Local.9baf3a40312f3984"));
        ...
        gainMin = new JLabel(org.openpnp.Translations.getString("Local.1f6fa6f69d185e60"));
        ...
        gainMax = new JLabel(org.openpnp.Translations.getString("Local.9baf3a40312f3984"));
        panelProperties.add(gainMax, "18, 14, center, default");

        zoomDefault = new JLabel(org.openpnp.Translations.getString("Local.cb8379ac2098aa16"));
