...
public class ActuatorSolutions implements Solutions.Subject {
    ...
    public static void findActuateIssues(Solutions solutions, Solutions.Subject holder, Actuator actuator, String qualifier, String uri) {
        if (actuator == null) {
            solutions.add(new Solutions.PlainIssue(
                    holder, 
                    org.openpnp.Translations.message("Local.865be955d6870907", (holder.getSubjectText()), (qualifier)), 
                    org.openpnp.Translations.message("Local.ee2f6d66b9f86ab9", (qualifier)), 
                    Severity.Warning,
                    uri));
        }
        else {
    ...
    protected void findActuatorIssues(Solutions solutions, Solutions.Subject holder, String qualifier,
        ...
        if (actuator == null) {
            ...
            if (!actuator.isDriverless()) {solutions.add(new Solutions.PlainIssue(
                    actuator, 
                    org.openpnp.Translations.message("Local.260d5c76418c7ee1", (qualifier), (actuator.getName())), 
                    org.openpnp.Translations.message("Local.5704206f9388cd4d"), 
                    Severity.Warning,
            ...
            for (CommandType commandType : commandTypes) {
                if (driver.getCommand(actuator, commandType) == null) {
                    solutions.add(new ActuatorGcodeIssue(
                            ...
                            org.openpnp.Translations.message("Local.3f3b54c9ac1bffa7", (qualifier), (actuator.getName()), (commandType)), 
                            org.openpnp.Translations.message("Local.a1ce81bbd9d1d4dd", ((commandType.name().contains("REGEX") ? org.openpnp.Translations.message("Local.a34b312df35460e5") : org.openpnp.Translations.message("Local.5d347fd948b66308"))), (driver.getName())), 
                            Severity.Warning,
                            uri));
                }
            }
    ...
    protected class ActuatorGcodeIssue extends Solutions.Issue {
        ...
        public ActuatorGcodeIssue(Subject subject, GcodeDriver driver, Solutions.Subject holder, String qualifier, 
                ...
                Object issue, Object solution, Severity severity, String uri) {
        ...
        public void setState(Solutions.State state) throws Exception {
            if (state == State.Solved) {
                if (newGcode.isEmpty()) {
                    throw new Exception(org.openpnp.Translations.format("Local.2e9b5471e0367b85", (commandType)));
                }
                if (newGcode.contains("\u00BF")) {
                    throw new Exception(org.openpnp.Translations.format("Local.aea1f2ad6dcbfa6d", (commandType), (qualifier)));
                }
            ...
            if (commandType == CommandType.ACTUATE_BOOLEAN_COMMAND) {
                ...
                return new Solutions.Issue.CustomProperty[] {
                        new Solutions.Issue.MultiLineTextProperty(
                                ...
                                org.openpnp.Translations.format("Local.15291afeb1a2faef", (commandType), (actuator.getName()))) {
        ...
        protected MultiLineTextProperty booleanCommandProperty(boolean on) {
            return new Solutions.Issue.MultiLineTextProperty(
                    org.openpnp.Translations.format("Local.b7bf939cf5028bbe", ((on ? "ON":"OFF")), (commandType.toString())),
                    org.openpnp.Translations.format("Local.823812685985c65b", ((on ? "ON":"OFF")), (commandType), (actuator.getName()))) {
