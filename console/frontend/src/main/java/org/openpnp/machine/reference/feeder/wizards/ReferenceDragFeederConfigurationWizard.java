...
public class ReferenceDragFeederConfigurationWizard
    ...
    public ReferenceDragFeederConfigurationWizard(ReferenceDragFeeder feeder) {
        ...
        panelGeneral.setBorder(new TitledBorder(null, org.openpnp.Translations.getString("Local.de322f87b5f5957b"), TitledBorder.LEADING,
        ...
        lblFeedRate = new JLabel(org.openpnp.Translations.getString("Local.b8485463c2eb38ab"));
        ...
        lblPeelOffActuatorId = new JLabel(org.openpnp.Translations.getString("Local.ef2dc09517fbd14d"));
        ...
        if (feeder.isPart0402()) {
	        lbl0402PartDetected = new JLabel(org.openpnp.Translations.getString("Local.d04cba4c360d85fa"));
        ...
        JLabel lblFeedStartLocation = new JLabel(org.openpnp.Translations.getString("Local.8b61d79c8efd02f8"));
        ...
        JLabel lblFeedEndLocation = new JLabel(org.openpnp.Translations.getString("Local.04b4395c17de0e73"));
        ...
        lblBackoffDistance = new JLabel(org.openpnp.Translations.getString("Local.1a82cf1691a270f1"));
