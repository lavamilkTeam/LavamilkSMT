...
public class AdvancedLoosePartFeederConfigurationWizard
    ...
    public AdvancedLoosePartFeederConfigurationWizard(AdvancedLoosePartFeeder feeder) {
        ...
        panel.setBorder(new TitledBorder(null, org.openpnp.Translations.getString("Local.c587c2601ccfc456"), TitledBorder.LEADING, TitledBorder.TOP,
                null, null));
        ...
        JButton btnEditPipeline = new JButton(org.openpnp.Translations.getString("Local.464c4ffd019e1e96"));
        btnEditPipeline.addActionListener(new BtnEditPipelineActionListener());
        
        JLabel lblFeedPipeline = new JLabel(org.openpnp.Translations.getString("Local.545bb80ed69ad1ee"));
        panel.add(lblFeedPipeline, "2, 2");
        panel.add(btnEditPipeline, "4, 2");

        JButton btnResetPipeline = new JButton(org.openpnp.Translations.getString("Local.daee7606b339f3c3"));
        btnResetPipeline.addActionListener(new BtnResetPipelineActionListener());
        panel.add(btnResetPipeline, "6, 2");
        
        JLabel lblTrainingPipeline = new JLabel(org.openpnp.Translations.getString("Local.7280a01cfec1cb4d"));
        panel.add(lblTrainingPipeline, "2, 4");
        
        JButton btnEditTrainingPipeline = new JButton(org.openpnp.Translations.getString("Local.464c4ffd019e1e96"));
        btnEditTrainingPipeline.addActionListener(new BtnEditTrainingPipelineActionListener());
        panel.add(btnEditTrainingPipeline, "4, 4");
        
        JButton btnResetTrainingPipeline = new JButton(org.openpnp.Translations.getString("Local.daee7606b339f3c3"));
        ...
        JLabel lblWarningThisFeeder = new JLabel(org.openpnp.Translations.getString("Local.4c32131ae130bfd5"));
