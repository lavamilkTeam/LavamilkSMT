...
public class ContactProbeNozzle extends ReferenceNozzle {
    ...
    public PropertySheet[] getPropertySheets() {
        return Collect.concat(super.getPropertySheets(), new PropertySheet[] {
                new PropertySheetWizardAdapter(new ContactProbeNozzleWizard(this), org.openpnp.Translations.format("Local.2d93ca827ef1378a")) });
    }
        ...
        if (isPartHeightProbingNeeded(part)) {
            ...
            if (partHeightProbing) { 
                ...
                if (partHeight.getValue() <= 0) {
                    throw new Exception(org.openpnp.Translations.format("Local.dbeac67182644c10", (partId), (getName())));
                }
                part.setHeight(partHeight);
                offsetZ = new Length(0, LengthUnit.Millimeters);
            }
    ...
    public Location contactProbe(boolean forward, Length contactProbeDepthZ) throws Exception {
        switch (contactProbeMethod) {
            case VacuumSense: {
                ...
                if (nozzleTip == null) {
                    throw new Exception(org.openpnp.Translations.format("Local.4a4e855b0dc206d2", (getName())));
                }
                if (nozzleTip.getMethodPartOff() == VacuumMeasurementMethod.None) {
                    throw new Exception(org.openpnp.Translations.format("Local.5286c2e1bbde8b5e", (nozzleTip.getName())));
                }
                if (!isVaccumActuatorEnabled()) {
                    throw new Exception(org.openpnp.Translations.format("Local.b182660ad69ddfdd", (getName())));
                }
                if (getVacuumSenseActuator() == null) {
                    throw new Exception(org.openpnp.Translations.format("Local.cbedce3fbf60d875", (getName())));
                }
                if (getPart() != null) {
                    throw new Exception(org.openpnp.Translations.format("Local.d944c35447cf185f", (getName())));
                }
                ...
                if (!isPartOff()) {
                    throw new Exception(org.openpnp.Translations.format("Local.57c8c88e288803f5", (getName()))); 
                }
                ...
                throw new Exception(org.openpnp.Translations.format("Local.c41d9975a1b5d6bf", (getName()))); 
            }
            ...
            default:
                throw new Exception(org.openpnp.Translations.format("Local.2f5df079c6995e82", (getName()))); 
        }
    }
    ...
    public void calibrateZ(ReferenceNozzleTip nt) throws Exception {
        if (nt != getCalibrationNozzleTip()) {
            throw new Exception(org.openpnp.Translations.format("Local.d2c3dca20ef500a9", (getName()), (nt.getName())));
        }
        if (nt == null) {
            throw new Exception(org.openpnp.Translations.format("Local.4ae96f9c8080c919", (getName())));
        }
        Location nominalLocation = nt.getTouchLocation();
        if (!nominalLocation.isInitialized()) {
            throw new Exception(org.openpnp.Translations.format("Local.2a406cdb0019e1fc", (nt.getName())));
        }
        resetZCalibration();
        ...
        if (Math.abs(offsetZ.convertToUnits(LengthUnit.Millimeters).getValue()) > maxZOffsetMm) {
            throw new Exception(org.openpnp.Translations.format("Local.e05e88467edcae5f", (getName()), (nt.getName()), (offsetZ)));
        }
    ...
    public static void referenceAllTouchLocationsZ() throws Exception {
        ...
        if (templateNozzleTip == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.5fa6befdd01fbfa7"));
        }
        // Always use the default nozzle.
        ContactProbeNozzle probeNozzle = ContactProbeNozzle.getDefaultNozzle();
        if (probeNozzle == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.af1c16f56113a273"));
        }
            ...
            if (solutions.isTargeting(Milestone.Basics)) {
                if (getContactProbeMethod() == ContactProbeMethod.ContactSenseActuator
                    ...
                    solutions.add(new Solutions.PlainIssue(
                            this, 
                            org.openpnp.Translations.message("Local.8458994a39e2bd0e", (getName())), 
                            org.openpnp.Translations.message("Local.92b5968f79be5e4a", (getName())), 
                            Severity.Error,
                    ...
                    if (contactProbeActuator.getCoordinatedAfterActuateEnum() != ActuatorCoordinationEnumType.WaitForUnconditionalCoordination) {
                        solutions.add(new Solutions.Issue(
                                ...
                                org.openpnp.Translations.message("Local.b864c99ed9b6579e"), 
                                org.openpnp.Translations.message("Local.b8cbd52c1d914d79"), 
                                Severity.Error,
                    ...
                    if (getCoordinateAxisZ() instanceof ControllerAxis) {
                        ...
                        if (driver != null && driver != oldDriver) {
                            solutions.add(new Solutions.Issue(
                                    this, 
                                    org.openpnp.Translations.message("Local.68fc40b46c3b2bef", (driver.getName()), (contactProbeActuator.getName()), ((oldDriver == null ? "(unassigned)" : oldDriver.getName()))), 
                                            org.openpnp.Translations.message("Local.d1b40b71f818de46", (driver.getName()), (contactProbeActuator.getName())), 
                                            Severity.Error,
                        ...
                        if (driver instanceof GcodeAsyncDriver) {
                            if (!((GcodeAsyncDriver) driver).isReportedLocationConfirmation()) { 
                                solutions.add(new Solutions.Issue(
                                        this, 
                                        org.openpnp.Translations.message("Local.74fcb34c634a4295", (driver.getName())), 
                                        org.openpnp.Translations.message("Local.35eed9b619dd4709"), 
                                        Severity.Error,
                            ...
                            solutions.add(new Solutions.PlainIssue(
                                    this, 
                                    org.openpnp.Translations.message("Local.a7a61e3ccf2b78a7", (driver.getName())), 
                                    org.openpnp.Translations.message("Local.5573399f1fc8e3a1"), 
                                    Severity.Error,
                                    "https://github.com/openpnp/openpnp/wiki/GcodeAsyncDriver#advanced-settings"));
                        }
                    }
                    if (contactProbeActuator.getDriver() instanceof GcodeDriver) {
                        ...
                        if (suggestedCommand != null) {
                            ...
                            if (currentCommand == null || currentCommand.isEmpty()) {
                                solutions.add(new Solutions.PlainIssue(
                                        this, 
                                        org.openpnp.Translations.message("Local.061d251ec836edfd", (contactProbeActuator.getName()), (gcodeDriver.getName())), 
                                        org.openpnp.Translations.message("Local.a60156a83d1891b0"),
                                        Severity.Error,
    ...
    public static void addConversionIssue(Solutions solutions, final ReferenceNozzle nozzle) {
        if (solutions.isTargeting(Milestone.Advanced)) {
            if (! (nozzle instanceof ContactProbeNozzle)) {
                solutions.add(new Solutions.Issue(
                        nozzle, 
                        org.openpnp.Translations.message("Local.6629aa81b6229da3"), 
                        org.openpnp.Translations.message("Local.aadf318a13551520"), 
            ...
            if (nozzle instanceof ContactProbeNozzle) {
                solutions.add(new Solutions.Issue(
                        nozzle, 
                        org.openpnp.Translations.message("Local.48e52090ddda232e"), 
                        org.openpnp.Translations.message("Local.608f9933f898d376"), 
                    ...
                    public String getExtendedDescription() {
                        return org.openpnp.Translations.format("Local.3ff84144769eb57d");
                    }
