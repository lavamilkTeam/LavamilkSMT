    ...
    public Action newAxisAction = new AbstractAction() {
        {
            ...
            putValue(NAME, org.openpnp.Translations.getString("Local.ec649c89cf4e814e"));
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            try {
                ...
                MessageBoxes.errorBox(MainFrame.get(), org.openpnp.Translations.getString("Local.f06957bdd7f2292d"), e);
            }
        }
    };
}
