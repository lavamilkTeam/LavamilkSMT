...
public class WebcamConfigurationWizard extends AbstractConfigurationWizard
    ...
    public WebcamConfigurationWizard(Webcams camera) {
        ...
        JLabel lblDeviceId = new JLabel(org.openpnp.Translations.getString("Local.6e0a0b9d8c5ee4d9"));
        ...
        comboBoxDeviceId = new org.openpnp.gui.components.LocalizedComboBox(deviceIds);
        panelGeneral.add(comboBoxDeviceId, "4, 2, left, default");

        chckbxGray = new JCheckBox(org.openpnp.Translations.getString("Local.510155600eb57ad3"));
