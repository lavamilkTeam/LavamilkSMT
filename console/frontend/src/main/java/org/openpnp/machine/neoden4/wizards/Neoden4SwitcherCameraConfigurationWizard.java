...
public class Neoden4SwitcherCameraConfigurationWizard extends AbstractConfigurationWizard {
    ...
    private void createUi() {
        ...
        lblExposure = new JLabel(org.openpnp.Translations.getString("Local.cc5454a4b7ce2113"));
        ...
        lblGain = new JLabel(org.openpnp.Translations.getString("Local.4e125a3ef68a00b0"));
