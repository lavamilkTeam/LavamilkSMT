...
public class ReferenceNozzle extends AbstractNozzle implements HeadMountable {
    ...
    public void pick(Part part,Feeder feeder) throws Exception {
        ...
        if (part == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.fd30e0bfec4c2e9a"));
        }
        if (nozzleTip == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.f7bef4e49346c52f"));
        }
    ...
    public void place() throws Exception {
        ...
        if (nozzleTip == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.ad2133eadde1c589"));
        }
    ...
    public Length getEffectiveSafeZ() throws Exception {
        ...
        if (safeZ == null) {
            throw new Exception(org.openpnp.Translations.format("Local.2c1bff61ed7a02cc", (getName())));
        }
    ...
    public void loadNozzleTip(NozzleTip nozzleTip, boolean withCalibration) throws Exception {
        ...
        if (this.nozzleTip != nozzleTip) {
            if (getPart() != null) {
                throw new Exception(org.openpnp.Translations.format("Local.318ada5a243a4959", (getName())));
            }
            ...
            if (!getCompatibleNozzleTips().contains(nt)) {
                throw new Exception(org.openpnp.Translations.getString("Local.4e92129201ea96e8"));
            }
    ...
    protected void assertManualChangeLocation() throws Exception {
        if (isManualNozzleTipChangeLocationUndefined()) {
            throw new Exception(org.openpnp.Translations.format("Local.b502892dad0462c0", (getName())));
        }
    }
    ...
    public Action deleteAction = new AbstractAction(org.openpnp.Translations.getString("Local.e4c5ef454423563e")) {
        {
        ...
        public void actionPerformed(ActionEvent arg0) {
            if (getHead().getNozzles().size() == 1) {
                MessageBoxes.errorBox(null, org.openpnp.Translations.getString("Local.9473b21c28e1173e"), org.openpnp.Translations.getString("Local.b62a1abb20274c6c"));
                return;
            }
    ...
    public Actuator getExpectedVacuumSenseActuator() throws Exception {
        ...
        if (actuator == null) {
            throw new Exception(org.openpnp.Translations.format("Local.6e9c691863f6b3bb", (getName())));
        }
        return actuator;
    }
    ...
    public Actuator getExpectedVacuumActuator() throws Exception {
        ...
        if (actuator == null) {
            throw new Exception(org.openpnp.Translations.format("Local.2dbf013e657c43c6", (getName())));
        }
        return actuator;
    }
    ...
    public Actuator getExpectedBlowOffActuator() throws Exception {
        ...
        if (actuator == null) {
            throw new Exception(org.openpnp.Translations.format("Local.90af796dd8c18b46", (getName())));
        }
        return actuator;
    }
