...
public class ReferenceNozzleTipToolChangerWizard extends AbstractConfigurationWizard {
    ...
    public ReferenceNozzleTipToolChangerWizard(ReferenceNozzleTip nozzleTip) {
        ...
        tcPostOneComboBoxActuator = new org.openpnp.gui.components.LocalizedComboBox();
        ...
        tcPostTwoComboBoxActuator = new org.openpnp.gui.components.LocalizedComboBox();
        ...
        tcPostThreeComboBoxActuator = new org.openpnp.gui.components.LocalizedComboBox();
        ...
        zCalibrationTrigger = new org.openpnp.gui.components.LocalizedComboBox(ZCalibrationTrigger.values());
        ...
        visionCalibration = new org.openpnp.gui.components.LocalizedComboBox(VisionCalibration.values());
        ...
        visionCalibrationTrigger = new org.openpnp.gui.components.LocalizedComboBox(VisionCalibrationTrigger.values());
    ...
    protected BufferedImage captureTemplateImage() throws Exception {
        ...
        if (location == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.a8a7250ee1a6fe2a"));
        }
        ...
        if (camera == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.9bfa306028aa3c51"));
        }
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            UiUtils.submitUiMachineTask(() -> {
                ...
                if (nozzle instanceof ContactProbeNozzle) {
                    ...
                    throw new Exception(org.openpnp.Translations.format("Local.c595bc50563d8c6f", (nozzle.getName())));
                }
            });
        }
    };
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            UiUtils.messageBoxOnException(() -> {
                if (!nozzleTip.getChangerStartLocation().isInitialized()) {
                    throw new Exception(org.openpnp.Translations.format("Local.4256afe7a604bd10", (nozzleTip.getName())));
                }
