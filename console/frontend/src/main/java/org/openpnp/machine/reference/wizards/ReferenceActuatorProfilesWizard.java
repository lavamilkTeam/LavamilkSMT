...
public class ReferenceActuatorProfilesWizard extends AbstractConfigurationWizard {
    ...
    protected void createUi() {
        ...
        panelInterlock.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), org.openpnp.Translations.getString("Local.90087245130446b5"), TitledBorder.LEADING, TitledBorder.TOP, null));
        ...
        lblActuator_1 = new JLabel(org.openpnp.Translations.getString("Local.d407b3cf8fcdd3e6"));
        panelInterlock.add(lblActuator_1, "2, 2, right, default");

        actuator1 = new org.openpnp.gui.components.LocalizedComboBox(new ActuatorsComboBoxModel(actuator.getHead() != null ? actuator.getHead() : machine));
        ...
        lblActuator_2 = new JLabel(org.openpnp.Translations.getString("Local.890d80fdc867cbfb"));
        panelInterlock.add(lblActuator_2, "2, 4, right, default");

        actuator2 = new org.openpnp.gui.components.LocalizedComboBox(new ActuatorsComboBoxModel(actuator.getHead() != null ? actuator.getHead() : machine));
        ...
        lblActuator_3 = new JLabel(org.openpnp.Translations.getString("Local.44e3316af9b30426"));
        panelInterlock.add(lblActuator_3, "2, 6, right, default");

        actuator3 = new org.openpnp.gui.components.LocalizedComboBox(new ActuatorsComboBoxModel(actuator.getHead() != null ? actuator.getHead() : machine));
        ...
        lblActuator_4 = new JLabel(org.openpnp.Translations.getString("Local.1cd3a71d60221566"));
        panelInterlock.add(lblActuator_4, "2, 8, right, default");

        actuator4 = new org.openpnp.gui.components.LocalizedComboBox(new ActuatorsComboBoxModel(actuator.getHead() != null ? actuator.getHead() : machine));
        ...
        lblActuator_5 = new JLabel(org.openpnp.Translations.getString("Local.d6874b937cc26d94"));
        panelInterlock.add(lblActuator_5, "2, 10, right, default");

        actuator5 = new org.openpnp.gui.components.LocalizedComboBox(new ActuatorsComboBoxModel(actuator.getHead() != null ? actuator.getHead() : machine));
        ...
        lblActuator_6 = new JLabel(org.openpnp.Translations.getString("Local.051a12595baa1a81"));
        panelInterlock.add(lblActuator_6, "2, 12, right, default");

        actuator6 = new org.openpnp.gui.components.LocalizedComboBox(new ActuatorsComboBoxModel(actuator.getHead() != null ? actuator.getHead() : machine));
        ...
        panelCondition.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), org.openpnp.Translations.getString("Local.535e52e4a2616ebe"), TitledBorder.LEADING, TitledBorder.TOP, null));
    ...
    private Action addProfileAction =
            new AbstractAction("", Icons.add) {
        {
            putValue(Action.SHORT_DESCRIPTION,
                    org.openpnp.Translations.getString("Local.87902bb21520650f"));
        }
    ...
    private Action deleteProfileAction =
        ...
        {
            putValue(Action.SHORT_DESCRIPTION,
                    org.openpnp.Translations.getString("Local.d5a1b63f77d79cb8"));
        }
    ...
    private Action permutateUpAction =
        ...
        {
            putValue(Action.SHORT_DESCRIPTION,
                    org.openpnp.Translations.getString("Local.a3329f3ac4d8b116"));
        }
    ...
    private Action permutateDownAction =
        ...
        {
            putValue(Action.SHORT_DESCRIPTION,
                    org.openpnp.Translations.getString("Local.3f2f5ecf013c01bf"));
        }
