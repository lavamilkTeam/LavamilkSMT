...
public class HttpActuatorConfigurationWizard extends AbstractActuatorConfigurationWizard {
    ...
    protected void createUi(AbstractMachine machine) {
        ...
        panelProperties.setBorder(new TitledBorder(null, org.openpnp.Translations.getString("Local.ae43692b2a310b8e"), TitledBorder.LEADING,
        ...
        lblOnUrl = new JLabel(org.openpnp.Translations.getString("Local.a7937a03a52015d8"));
        ...
        lblOffUrl = new JLabel(org.openpnp.Translations.getString("Local.0f3a82d11461d7f5"));
        ...
        lblParametricUrl = new JLabel(org.openpnp.Translations.getString("Local.0e2d8b30046ce9c4"));
        lblParametricUrl.setToolTipText(org.openpnp.Translations.getString("Local.1e4a8a3d79f1d917"));
        ...
        lblReadUrl = new JLabel(org.openpnp.Translations.getString("Local.56b2927b3c406451"));
        ...
        lblRegex = new JLabel(org.openpnp.Translations.getString("Local.2aa42833c3291455"));
