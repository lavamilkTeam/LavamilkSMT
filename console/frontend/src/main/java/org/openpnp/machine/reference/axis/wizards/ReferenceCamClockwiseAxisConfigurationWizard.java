...
public class ReferenceCamClockwiseAxisConfigurationWizard extends AbstractAxisConfigurationWizard {
    ...
    public ReferenceCamClockwiseAxisConfigurationWizard(AbstractMachine machine, ReferenceCamClockwiseAxis axis) {
        ...
        panelTransformation.setBorder(new TitledBorder(null, org.openpnp.Translations.getString("Local.5aed84a77680dfa5"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        lblInputAxis = new JLabel(org.openpnp.Translations.getString("Local.7c5e38c4c8a8bada"));
