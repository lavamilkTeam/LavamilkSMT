...
public class CameraSolutions implements Solutions.Subject  {
        ...
        if (solutions.isTargeting(Milestone.Vision)) {
            ...
            if (previewFps > 15) {
                solutions.add(new Solutions.Issue(
                        camera, 
                        org.openpnp.Translations.message("Local.ebde3d24d461f490"), 
                        org.openpnp.Translations.message("Local.4df033a497172655"), 
                        Severity.Suggestion,
            ...
            if (! camera.isSuspendPreviewInTasks()) {
                solutions.add(new Solutions.Issue(
                        camera, 
                        org.openpnp.Translations.message("Local.5ccff79dd9c818a5", (((camera instanceof SwitcherCamera) ? "For a SwitcherCamera it is mandatory" : "It is recommended"))), 
                        org.openpnp.Translations.message("Local.83358367e6e0a9eb"), 
            ...
            if (! camera.isAutoVisible()) {
                solutions.add(new Solutions.Issue(
                        camera, 
                        org.openpnp.Translations.message("Local.e46c29b8e326a39c"), 
                        org.openpnp.Translations.message("Local.9f4bae5af9beef94"), 
                        Severity.Suggestion,
                        "https://github.com/openpnp/openpnp/wiki/Setup-and-Calibration_General-Camera-Setup#general-configuration") {
            ...
            if (view != null) {
                ...
                if (renderingQuality.ordinal() < RenderingQuality.High.ordinal()) {
                    solutions.add(new Solutions.Issue(
                            camera, 
                            org.openpnp.Translations.message("Local.c6a047b4811c8042"), 
                            org.openpnp.Translations.message("Local.ec2e0a0c9b5399a9"), 
                            Severity.Suggestion,
            ...
            if (machine instanceof ReferenceMachine 
                ...
                if ((head == null || visionSolutions.isSolvedPrimaryXY(head)) 
                    ...
                    if (oldSettleMethod == SettleMethod.FixedTime) {
                        solutions.add(new Solutions.Issue(
                                camera, 
                                org.openpnp.Translations.message("Local.412bdc32ae6b896c"), 
                                org.openpnp.Translations.message("Local.bfbd739ecef378ba"), 
                                Severity.Fundamental,
                            ...
                            public String getExtendedDescription() {
                                return org.openpnp.Translations.format("Local.a07f5536177222e7", ((movable == camera ? 
                                                org.openpnp.Translations.getString("Local.f3b7c91c18f4719d")+camera.getName()+org.openpnp.Translations.getString("Local.9345441d17f41c58")
                                                : (movable != null ? 
                                                        org.openpnp.Translations.getString("Local.fa236ef8c7d626f0")+movable.getClass().getSimpleName()+" "+movable.getName()
                                                        +org.openpnp.Translations.getString("Local.c7220f29bef4b160")+camera.getName()+org.openpnp.Translations.getString("Local.8999ac364ed513ec")
                                                        : ""))), ((getState() == State.Solved  ? 
                                                org.openpnp.Translations.getString("Local.577578d5ae752bf6")+camera.getSettleMethod()+org.openpnp.Translations.getString("Local.77be1a8c149b4805")+camera.getRecordedComputeMilliseconds()+org.openpnp.Translations.getString("Local.5d8f8486355911ec")+camera.getRecordedSettleMilliseconds()+" ms</td></tr>"
                                                + "</table><br/>"
                                                + (camera.getRecordedSettleMilliseconds() > camera.getSettleTimeoutMs()/2 ?
                                                        org.openpnp.Translations.getString("Local.50104017de076b21") : "")
                                                + org.openpnp.Translations.getString("Local.90245159474d813b")+camera.getName()+".</p>"
                                                : "")));
                            }
                            @Override
                            public void setState(Solutions.State state) throws Exception {
            ...
            if (!camera.isWhiteBalanced()) {
                ...
                if (!(Arrays.equals(histogram[0], histogram[1]) || Arrays.equals(histogram[0], histogram[2]))) {
                    ...
                    solutions.add(new Solutions.Issue(
                            camera, 
                            org.openpnp.Translations.message("Local.34e07a0e14b7036f", (camera.getName())), 
                            org.openpnp.Translations.message("Local.c96fa25a40980471"), 
                            Severity.Suggestion,
                        ...
                        @Override 
                        public String getExtendedDescription() {
                            return org.openpnp.Translations.format("Local.4228d9c89a7b96f4", ((_propertiesOK ? "" : org.openpnp.Translations.getString("Local.d5141c657afb38fb"))), (camera.getName()));
                        }
    ...
    protected boolean addCapturePropertyAutoSolution(Solutions solutions, 
        ...
        if (property.isAuto()) {
            ...
            solutions.add(new Solutions.Issue(
                    camera, 
                    org.openpnp.Translations.message("Local.e121a3f5b5de5bff", (propertyName), (camera.getName())), 
                    org.openpnp.Translations.message("Local.58be5ce397f5f788", (propertyName), (propertyName), (valueName)), 
                            Severity.Suggestion,
                            uri) {
    ...
    protected boolean addCapturePropertyValueSolution(Solutions solutions, 
        ...
        if (property.getValue() != wantedValue || property.isAuto()) {
            ...
            solutions.add(new Solutions.Issue(
                    camera, 
                    org.openpnp.Translations.message("Local.2d80372b1f7f83f7", (propertyName), (camera.getName()), (wantedValue)), 
                    org.openpnp.Translations.message("Local.9508f6a482a2df72", ((oldAuto ? "Switch off the Auto "+propertyName+" and " : "Therefore, ")), (valueName)), 
                            Severity.Suggestion,
                            uri) {
