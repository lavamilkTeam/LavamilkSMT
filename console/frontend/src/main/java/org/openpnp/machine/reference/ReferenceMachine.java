...
public class ReferenceMachine extends AbstractMachine {
    ...
    public void findIssues(Solutions solutions) {
        ...
        if (solutions.isTargeting(Milestone.Advanced)) {
            if (getMotionPlanner() instanceof NullMotionPlanner) {
                solutions.add(new Solutions.Issue(
                        this, 
                        org.openpnp.Translations.message("Local.1499a9f99ce4ba9c"), 
                        org.openpnp.Translations.message("Local.117d592322165fa8"), 
            ...
            if (!(getMotionPlanner() instanceof NullMotionPlanner)) {
                solutions.add(new Solutions.Issue(
                        this, 
                        org.openpnp.Translations.message("Local.2c2f36e44c8f3a79"), 
                        org.openpnp.Translations.message("Local.3e8c4136e8f786d3"), 
                    ...
                    public String getExtendedDescription() {
                        return org.openpnp.Translations.format("Local.cab2362df490ca5d");
                    }
        ...
        if (solutions.isTargeting(Milestone.Basics) && ! isAutoToolSelect()) {
            solutions.add(new Solutions.Issue(
                    this, 
                    org.openpnp.Translations.message("Local.5b4eb66f25c40777"), 
                    org.openpnp.Translations.message("Local.68137e6397b86407"), 
