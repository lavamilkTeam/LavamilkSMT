...
public class ReferenceTrayFeederConfigurationWizard
    ...
    public ReferenceTrayFeederConfigurationWizard(ReferenceTrayFeeder feeder) {
        ...
        JLabel lblFeedStartLocation = new JLabel(org.openpnp.Translations.getString("Local.8807635f8ee82973"));
        ...
        JLabel lblTrayCount = new JLabel(org.openpnp.Translations.getString("Local.c97429919fb8af10"));
    ...
    protected void saveToModel() {
        ...
        if (feeder.getOffsets().getX() == 0 && feeder.getTrayCountX() > 1) {
            MessageBoxes.errorBox(this, org.openpnp.Translations.getString("Local.54a0e8c17ebb21a1"),
                    org.openpnp.Translations.getString("Local.7f76b564296f1a7f"));
        }
        if (feeder.getOffsets().getY() == 0 && feeder.getTrayCountY() > 1) {
            MessageBoxes.errorBox(this, org.openpnp.Translations.getString("Local.54a0e8c17ebb21a1"),
                    org.openpnp.Translations.getString("Local.7674a65d7a05f5d1"));
        }
    }
}
