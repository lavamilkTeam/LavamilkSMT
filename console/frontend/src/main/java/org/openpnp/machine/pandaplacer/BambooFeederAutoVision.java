...
//        firePropertyChange("postPickActuatorName", oldValue2, postPickActuatorName);
    ...
    private void feedTape(Nozzle nozzle, Double feedPitch) throws Exception {
        if (feedActuatorName == null || feedActuatorName.equals("")) {
            throw new Exception(org.openpnp.Translations.format("Local.e1588e379b6454d9", (getName())));
        }
        ...
        if (actuator == null) {
            throw new Exception(org.openpnp.Translations.format("Local.cb7dc96a5d0da56d", (feedActuatorName)));
        }
    ...
    public void postPick(Nozzle nozzle) throws Exception {
        ...
        if (actuator == null) {
            throw new Exception(org.openpnp.Translations.format("Local.5363e497767a59b9", (postPickActuatorName)));
        }
        // Note by using the Object generic method, the value will be properly interpreted according to actuator.valueType.
