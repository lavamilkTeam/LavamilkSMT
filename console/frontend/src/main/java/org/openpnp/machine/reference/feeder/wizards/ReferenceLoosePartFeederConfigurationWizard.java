...
public class ReferenceLoosePartFeederConfigurationWizard
    ...
    public ReferenceLoosePartFeederConfigurationWizard(ReferenceLoosePartFeeder feeder) {
        ...
        JButton btnEditPipeline = new JButton(org.openpnp.Translations.getString("Local.382eac4077ca856c"));
        ...
        JButton btnResetPipeline = new JButton(org.openpnp.Translations.getString("Local.47a6eb4dae7fd9eb"));
