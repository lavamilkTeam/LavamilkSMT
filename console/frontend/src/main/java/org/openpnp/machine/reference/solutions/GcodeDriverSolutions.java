        ...
        if (solutions.isTargeting(Milestone.Advanced)) {
            if (!(gcodeDriver instanceof GcodeAsyncDriver)) {
                Solutions.Issue issue = new Solutions.Issue(
                        gcodeDriver, 
                        org.openpnp.Translations.message("Local.bd256a554b1c8bfb"), 
                        org.openpnp.Translations.message("Local.1461b7cce935881f"), 
            ...
            if (gcodeDriver instanceof GcodeAsyncDriver) {
                Solutions.Issue issue = new Solutions.Issue(
                        gcodeDriver, 
                        org.openpnp.Translations.message("Local.5f2285be05350e14"), 
                        org.openpnp.Translations.message("Local.f8af298a189bdf6b"), 
                    ...
                    public String getExtendedDescription() {
                        return org.openpnp.Translations.format("Local.1ee4ae45acedaef9");
                    }
        ...
        if (solutions.isTargeting(Milestone.Connect)) {
            if (gcodeDriver.getCommunicationsType() == CommunicationsType.tcp
                ...
                solutions.add(new Solutions.PlainIssue(
                        gcodeDriver, 
                        org.openpnp.Translations.message("Local.87f79b5cc30af8e3"), 
                        org.openpnp.Translations.message("Local.ba3e9c5bd295a306"), 
                        Severity.Fundamental,
            ...
            if (gcodeDriver.getDetectedFirmware() == null) {
                solutions.add(new Solutions.Issue(
                        gcodeDriver, 
                        org.openpnp.Translations.message("Local.85a4876e47bf1a52", ((machine.isEnabled() ? 
                                        (gcodeDriver.isSpeakingGcode() ? "failure, check log" : "controller may not speak Gcode") 
                                        : "machine is disabled"))), 
                                org.openpnp.Translations.message("Local.a4f5824b259d50ae"), 
                                Severity.Fundamental,
                    ...
                    public Solutions.Issue.Choice[] getChoices() {
                        return new Solutions.Issue.Choice[] {
                                new Solutions.Issue.Choice(true, 
                                        org.openpnp.Translations.format("Local.0722aa53b028d963"),
                                                Icons.powerOn),
                                new Solutions.Issue.Choice(false, 
                                        org.openpnp.Translations.format("Local.e7e3b7cc5a819a55"),
                                                Icons.powerOff),
                        };
                    }
                ...
                if (gcodeDriver.getFirmwareProperty("FIRMWARE_NAME", "").contains("Smoothieware")) {
                    ...
                    if (firmware == FirmwareType.SmoothiewareChmt) {
                        ...
                        solutions.add(new Solutions.PlainIssue(
                                gcodeDriver, 
                                org.openpnp.Translations.message("Local.a7b5e537ddf29db4", (gcodeDriver.getDetectedFirmware())), 
                                org.openpnp.Translations.message("Local.310791e25980eaa4"), 
                                Severity.Error, 
                    ...
                    if (firmwarePrimaryAxesCount != null 
                        ...
                        solutions.add(new Solutions.PlainIssue(
                                gcodeDriver, 
                                org.openpnp.Translations.message("Local.0435ad3278028912", (firmwareAxesCount)), 
                                org.openpnp.Translations.message("Local.a7197803e8e545f0", (firmwareAxesCount), (firmwareAxesCount)), 
                                Severity.Warning, 
                                "https://github.com/openpnp/openpnp/wiki/Motion-Controller-Firmwares#smoothieware"));
                    }
                }
                    ...
                    if (major == null || minor == null
                        ...
                        solutions.add(new Solutions.PlainIssue(
                                gcodeDriver,
                                org.openpnp.Translations.message("Local.4f3ac858f787b206", (firmwareVersion)),
                                org.openpnp.Translations.message("Local.774517e10dfc2941"),
                                Severity.Error,
                    ...
                    if (gcodeDriver.getConfiguredAxes() != null) {
                        ...
                        if (gcodeDriver.getConfiguredAxes().contains("(r)")) {
                            solutions.add(new Solutions.PlainIssue(
                                    gcodeDriver,
                                    org.openpnp.Translations.message("Local.653a86b221462ec3"),
                                    org.openpnp.Translations.message("Local.2ef6a5a983c89c6f"),
                                    Severity.Error,
                    ...
                    if (firmwareAxesCount > 3) { 
                        ...
                        solutions.add(new Solutions.PlainIssue(
                                gcodeDriver, 
                                org.openpnp.Translations.message("Local.58457b73b3877289", (gcodeDriver.getDetectedFirmware())), 
                                org.openpnp.Translations.message("Local.54744186c0974dcd"), 
                                Severity.Error, 
                    ...
                    solutions.add(new Solutions.PlainIssue(
                            gcodeDriver, 
                            org.openpnp.Translations.message("Local.b60abba25d64d6db", (gcodeDriver.getDetectedFirmware())), 
                            org.openpnp.Translations.message("Local.97e8103e825e7288"), 
                            Severity.Warning, 
                ...
                if (gcodeDriver.getCommunicationsType() == CommunicationsType.serial 
                    ...
                    if (oldFlowControl != newFlowControl) {
                        solutions.add(new Solutions.Issue(
                                gcodeDriver, 
                                org.openpnp.Translations.message("Local.7986dc59785d0fe4"),
                                org.openpnp.Translations.message("Local.ff667f4433fefafd", (newFlowControl.name()), ((newFlowControl == FlowControl.Off ? " The detected "+firmware+" controller is known to not "
            ...
            if (gcodeDriver.isConnectionKeepAlive()) {
                solutions.add(new Solutions.Issue(
                        gcodeDriver, 
                        org.openpnp.Translations.message("Local.1884e90625acf9fe"), 
                        org.openpnp.Translations.message("Local.9e6f301197437835"), 
                        Severity.Warning,
                        null) {
            ...
            if (solutions.isTargeting(Milestone.Basics)) {
                if (gcodeDriver instanceof GcodeAsyncDriver) {
                    ...
                    if (locationConfirmationRecommended != locationConfirmation) {
                        solutions.add(new Solutions.Issue(
                                gcodeDriver, 
                                (locationConfirmationRecommended ? (confirmationFlowControl ? org.openpnp.Translations.message("Local.ad3cfcb51687498c") : org.openpnp.Translations.message("Local.15ff4228a9040791")) : (!hasAxes ? org.openpnp.Translations.message("Local.3136eee3ed9dfed2") : org.openpnp.Translations.message("Local.e093f259833e0c6e"))),
                                (locationConfirmationRecommended ? org.openpnp.Translations.message("Local.7bfa00a30bca6094") : org.openpnp.Translations.message("Local.23149a77086da512")),
                    ...
                    if (confirmationFlowControlRecommended != confirmationFlowControl) {
                        solutions.add(new Solutions.Issue(
                                gcodeDriver,
                                (confirmationFlowControl ? org.openpnp.Translations.message("Local.c2865f9325303347") : org.openpnp.Translations.message("Local.7fe1aba372e9876d", ((hasAxes ? "" : org.openpnp.Translations.message("Local.bd073a59d461ea57"))), ((serialFlowControlOff ? org.openpnp.Translations.message("Local.48a4686ceb375683") : "")))),
                                (confirmationFlowControl ? org.openpnp.Translations.message("Local.79b8d31c3d0c6245") : org.openpnp.Translations.message("Local.49ea9c105d1e4528")),
                                confirmationFlowControl ? Severity.Suggestion : Severity.Error,
                                "https://github.com/openpnp/openpnp/wiki/GcodeAsyncDriver#advanced-settings") {
                ...
                if (hasAxes) { 
                    if (gcodeDriver.isSupportingPreMove()) {
                        solutions.add(new Solutions.Issue(
                                gcodeDriver, 
                                org.openpnp.Translations.message("Local.1abaf86241722d86"), 
                                org.openpnp.Translations.message("Local.11a166d2edcffe2b"), 
                                Severity.Fundamental,
                        ...
                        solutions.add(new Solutions.Issue(
                                gcodeDriver, 
                                org.openpnp.Translations.message("Local.ca3ace1a32769d46"), 
                                org.openpnp.Translations.message("Local.7721db65b07f3065"), 
                                Severity.Fundamental,
                                "https://github.com/openpnp/openpnp/wiki/Advanced-Motion-Control#migration-from-a-previous-version") {
                    ...
                    if (solutions.isTargeting(Milestone.Kinematics)) {
                        ...
                        if (gcodeDriver.getMotionControlType().isUnpredictable() 
                            ...
                            solutions.add(new Solutions.Issue(
                                    gcodeDriver, 
                                    ((firmware == FirmwareType.TinyG) ? org.openpnp.Translations.message("Local.c39595d24fc2bd16", (newMotionControlType.name())) : org.openpnp.Translations.message("Local.6d123fe3f37fab65")), 
                                    org.openpnp.Translations.message("Local.ad7e437720d89eb3", (newMotionControlType.name())), 
                            ...
                            solutions.add(new Solutions.Issue(
                                    gcodeDriver, 
                                    org.openpnp.Translations.message("Local.e8c24393e797e38e"), 
                                    org.openpnp.Translations.message("Local.37eb31f6680590b7"), 
                                    Severity.Suggestion,
                                    "https://github.com/openpnp/openpnp/wiki/GcodeAsyncDriver#gcodedriver-new-settings") {
                        ...
                        if (oldMotionControlType != newMotionControlType) {
                            solutions.add(new Solutions.Issue(
                                    gcodeDriver, 
                                    org.openpnp.Translations.message("Local.c1aba45558cee1d0"), 
                                    org.openpnp.Translations.message("Local.ad7e437720d89eb3", (newMotionControlType.name())), 
                                    Severity.Information,
                                    "https://github.com/openpnp/openpnp/wiki/GcodeAsyncDriver#gcodedriver-new-settings") {
                                ...
                                @Override 
                                public String getExtendedDescription() {
                                    return org.openpnp.Translations.format("Local.8883703856b9305d", (newMotionControlType.name()), (oldMotionControlType.name()));
                                }
                ...
                if (gcodeDriver.isSpeakingGcode()) {
                    if (solutions.isTargeting(Milestone.Advanced)) {
                        if (!gcodeDriver.isCompressGcode()) {
                            solutions.add(new Solutions.Issue(
                                    gcodeDriver, 
                                    org.openpnp.Translations.message("Local.020f928fe92f53fe"), 
                                    org.openpnp.Translations.message("Local.a1cbee157c206ff5"), 
                                    Severity.Suggestion,
                                    "https://github.com/openpnp/openpnp/wiki/GcodeAsyncDriver#gcodedriver-new-settings") {
                        ...
                        if (!gcodeDriver.isRemoveComments()) {
                            solutions.add(new Solutions.Issue(
                                    gcodeDriver, 
                                    org.openpnp.Translations.message("Local.d79a7ec4b68be893"), 
                                    org.openpnp.Translations.message("Local.f83f2e246ef81a63"), 
                                    Severity.Suggestion,
                                    "https://github.com/openpnp/openpnp/wiki/GcodeAsyncDriver#gcodedriver-new-settings") {
                        ...
                        if (gcodeDriver.isCompressGcode()) {
                            solutions.add(new Solutions.Issue(
                                    gcodeDriver, 
                                    org.openpnp.Translations.message("Local.0b20e2082347fbdd"), 
                                    org.openpnp.Translations.message("Local.c59b8339de8eefc3"), 
                                    Severity.Information,
                                    "https://github.com/openpnp/openpnp/wiki/GcodeAsyncDriver#gcodedriver-new-settings") {
                                ...
                                @Override 
                                public String getExtendedDescription() {
                                    return org.openpnp.Translations.format("Local.0e1d56a905ec564a");
                                }
                        ...
                        if (gcodeDriver.isRemoveComments()) {
                            solutions.add(new Solutions.Issue(
                                    gcodeDriver, 
                                    org.openpnp.Translations.message("Local.642f46c35bf752b2"), 
                                    org.openpnp.Translations.message("Local.f669d15626336d38"), 
                                    Severity.Information,
                                    "https://github.com/openpnp/openpnp/wiki/GcodeAsyncDriver#gcodedriver-new-settings") {
                                ...
                                @Override 
                                public String getExtendedDescription() {
                                    return org.openpnp.Translations.format("Local.ec7557f12856e436");
                                }
                    ...
                    if (axis.getLetter().isEmpty()) {
                        ...
                        if (firmwarePrimaryAxesCount != null 
                            ...
                            if (axis.isRotationalOnController()) {
                                ...
                                solutions.add(new Solutions.Issue(
                                        axis, 
                                        org.openpnp.Translations.message("Local.37dbd86fc01840b1"), 
                                        org.openpnp.Translations.message("Local.d5f0e441229ccbd8", ((oldInvertLinearRotational ? "Disable" : "Enable"))), 
                                        Severity.Error,
                            ...
                            if (rotational ^ axis.isRotationalOnController()) {
                                ...
                                solutions.add(new Solutions.Issue(
                                        axis, 
                                        org.openpnp.Translations.message("Local.4cb4176045eb2204", ((rotational ? "rotational" : "linear"))), 
                                        org.openpnp.Translations.message("Local.d5f0e441229ccbd8", ((oldInvertLinearRotational ? "Disable" : "Enable"))), 
                                        Severity.Warning,
                ...
                for (Command command : gcodeDriver.commands) {
                    ...
                    solutions.add(new Solutions.Issue(
                            gcodeDriver,
                            org.openpnp.Translations.message("Local.3b20b2ff7ff8345c", (headMountable)),
                                    org.openpnp.Translations.message("Local.cb876cb18f380e2e"),
                                    Severity.Suggestion,
                    ...
                    if (hasAxes) {
                        try {
                            ...
                            if (gcodeDriver.getReportedAxes() != null 
                                ...
                                solutions.add(new Solutions.PlainIssue(
                                        gcodeDriver, 
                                        org.openpnp.Translations.message("Local.e5fc1291f71a788d", (pattern), (gcodeDriver.getReportedAxes())), 
                                        (dialect.isSmoothie() ? org.openpnp.Translations.message("Local.9d637d3c72d4fb9e") : org.openpnp.Translations.message("Local.9ed3098d0169aa4d")), 
                                        Severity.Error,
        ...
        if (suggestedCommand != null && !suggestedCommand.equals(currentCommand)) {
            ...
            solutions.add(new Solutions.Issue(
                ...
                public String getExtendedDescription() {
                    ...
                    if (suggestedCommand.isEmpty()) {
                        r += org.openpnp.Translations.getString("Local.75817f8b3db6029e");
                    } else {
                        r += org.openpnp.Translations.getString("Local.c04923cec19c7a5e")+suggestedCommand+"</pre>\n";
                    }
                    String prev = gcodeDriver.getCommand(headMountable, commandType);
                    if(prev != null && !prev.isEmpty()) {
                        r += org.openpnp.Translations.getString("Local.ea2a27d61fd16c2e")+prev+"</pre>\n";
                    }
                    r += "</html>";
                    return r;
                }
            ...
            for (Head head : Configuration.get().getMachine().getHeads()) {
                for (HeadMountable hm : head.getHeadMountables()) {
                    ...
                    if (commandHeadMountable != null) {
                        solutions.add(new Solutions.Issue(
                                gcodeDriver,
                                org.openpnp.Translations.message("Local.eb194e33d2b2df73", (hm.getClass().getSimpleName()), (hm.getName()), (commandType)),
                                org.openpnp.Translations.message("Local.e8929863b3cd42f8"),
                                Severity.Error,
                                "https://github.com/openpnp/openpnp/wiki/Advanced-Motion-Control#migration-from-a-previous-version") {
