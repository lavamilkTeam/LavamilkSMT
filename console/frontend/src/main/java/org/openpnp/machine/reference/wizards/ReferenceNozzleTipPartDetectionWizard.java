...
public class ReferenceNozzleTipPartDetectionWizard extends AbstractConfigurationWizard {
    ...
    public ReferenceNozzleTipPartDetectionWizard(ReferenceNozzleTip nozzleTip) {
        ...
        methodPartOn = new org.openpnp.gui.components.LocalizedComboBox(ReferenceNozzleTip.VacuumMeasurementMethod.values());
        ...
        methodPartOff = new org.openpnp.gui.components.LocalizedComboBox(ReferenceNozzleTip.VacuumMeasurementMethod.values());
