...
public class ReferenceHeadConfigurationWizard extends AbstractConfigurationWizard {
    ...
    private void createUi() {
        ...
        visualHomingMethod = new org.openpnp.gui.components.LocalizedComboBox(VisualHomingMethod.values());
        ...
        comboBoxZProbeActuator = new org.openpnp.gui.components.LocalizedComboBox();
        ...
        comboBoxPumpActuator = new org.openpnp.gui.components.LocalizedComboBox();
        ...
        vacuumPumpControl = new org.openpnp.gui.components.LocalizedComboBox(AbstractHead.VacuumPumpControl.values());
