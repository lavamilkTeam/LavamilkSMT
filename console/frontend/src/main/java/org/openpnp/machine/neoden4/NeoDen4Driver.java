...
//            }
    ...
    int expect(int expected) throws Exception {
        ...
        if (received != expected) {
            throw new Exception(String.format(org.openpnp.Translations.getString("Local.d06e603667ec5b7b"), expected, received));
        }
        return received;
    }
    ...
    public void home(Machine machine) throws Exception {
        ...
        if (! waitForStatusReady(100, 30000)) {
            throw new Exception(org.openpnp.Translations.getString("Local.967583321fff811a"));
        }
...
//        CalibrationLogger.addToLog("\n====================== HARD HOME ======================\n");    	
    ...
    public AxesLocation getReportedLocation(long timeout) throws Exception {
        ...
        throw new Exception(org.openpnp.Translations.getString("Local.26d8d6c82809ffb1"));
    }
    ...
    public void moveStep(int sx, int sy) throws Exception {
        ...
        if (! waitForStatusReady(100, 30000)) {
            throw new Exception(org.openpnp.Translations.getString("Local.d0d77f1ec0191eef"));
        }
    ...
    private void moveToInternal(HeadMountable hm, MoveToCommand move) 
        ...
        for(ControllerAxis axis : displacement.byType(Axis.Type.Rotation)
            ...
            if (index < 1 || index > 4) {
                throw new Exception(org.openpnp.Translations.format("Local.ed61571b531f5206", (axis.getLetter()), (axis.getName())));
            }            
            else {
        ...
        for(ControllerAxis axis : displacement.byType(Axis.Type.Z)
            ...
            if (index < 1 || index > 4) {
                throw new Exception(org.openpnp.Translations.format("Local.383404220cd2eb92", (axis.getLetter()), (axis.getName())));
            }            
            else {
    ...
    public void moveTo(HeadMountable hm, MoveToCommand move)
        ...
        if(!isAlreadyHomed) {
            throw new Exception(org.openpnp.Translations.getString("Local.67c2f704c8b88728"));
        }
...
//                    actuate(actuator, 0.0);
    ...
    private int getNozzleAirValue(int nozzleNum) throws Exception {
        ...
        if (!success) {
            ...
            if (airValue > 110) {
                Logger.trace(String.format(org.openpnp.Translations.getString("Local.e98593b87f03adf5"), airValue));
                // HACK
    ...
    public PropertySheet[] getPropertySheets() {
        return new PropertySheet[] {
            ...
            new PropertySheetWizardAdapter(new Neoden4DriverConfigurationWizard(this), org.openpnp.Translations.format("Local.8f1cc42d7c1ceb0c"))
        };
    }
