...
public class SlotSchultzFeeder extends SchultzFeeder {
    ...
    public void feed(Nozzle nozzle) throws Exception {
        if (getFeeder() == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.1f434ba69c0632ce"));
        }
        super.feed(nozzle);
    }
    ...
    public void setBank(Bank bank) throws Exception {
        if (bank == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.52c4c57750313f60"));
        }
        this.bank = bank;
    }
    ...
    public void setFeeder(Feeder feeder) throws Exception {
        if (feeder != null) {
          ...
          if (getBank().getFeeder(feeder.getId()) == null) {
              throw new Exception(org.openpnp.Translations.getString("Local.c8d8be3bd8cbf380"));
          }
        }
