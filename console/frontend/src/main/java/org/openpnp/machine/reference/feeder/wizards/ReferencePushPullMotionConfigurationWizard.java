...
extends AbstractConfigurationWizard {
    ...
    public ReferencePushPullMotionConfigurationWizard(ReferencePushPullFeeder feeder) {
        ...
        panelPushPull.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), org.openpnp.Translations.getString("Local.4e63bb0037937bb1"), TitledBorder.LEADING, TitledBorder.TOP, null));
        ...
        lblActuatorId = new JLabel(org.openpnp.Translations.getString("Local.36157e7c4bf9c521"));
        lblActuatorId.setToolTipText(org.openpnp.Translations.getString("Local.347e959750b8258d"));
        panelPushPull.add(lblActuatorId, "2, 2, right, default");

        actuator = new org.openpnp.gui.components.LocalizedComboBox();
        ...
        lblPeelOffActuatorId = new JLabel(org.openpnp.Translations.getString("Local.cdae1084466cd1e6"));
        lblPeelOffActuatorId.setToolTipText(org.openpnp.Translations.getString("Local.0cf65e680aa2124a"));
        panelPushPull.add(lblPeelOffActuatorId, "2, 4, right, default");

        actuator2 = new org.openpnp.gui.components.LocalizedComboBox();
        ...
        lblRotation = new JLabel(org.openpnp.Translations.getString("Local.57b5e2fc1bba18bb"));
        panelPushPull.add(lblRotation, "10, 8, center, default");

        lblPush = new JLabel("↓");
        lblPush.setToolTipText(org.openpnp.Translations.getString("Local.83b1e14d259ee55e"));
        panelPushPull.add(lblPush, "12, 8, center, default");

        lblMulti = new JLabel("↑↓");
        lblMulti.setToolTipText(org.openpnp.Translations.getString("Local.e6bec6093ddef9ec"));
        panelPushPull.add(lblMulti, "14, 8, 3, 1, center, default");

        lblPull = new JLabel("↑");
        lblPull.setToolTipText(org.openpnp.Translations.getString("Local.11c00b3094bf3399"));
        panelPushPull.add(lblPull, "18, 8, center, default");

        lblCalibrate = new JLabel(org.openpnp.Translations.getString("Local.2d00e41032971e68"));
        lblCalibrate.setToolTipText(org.openpnp.Translations.getString("Local.3232e57b3bd83a70"));
        ...
        additiveRotation = new JCheckBox(org.openpnp.Translations.getString("Local.765fc5369dc160b0"));
        additiveRotation.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent arg0) {
                resetRotation();
            }
        });
        additiveRotation.setToolTipText(org.openpnp.Translations.getString("Local.7a4bfe2ec993c653"));
        panelPushPull.add(additiveRotation, "10, 10, center, default");

        JLabel lblFeedStartLocation = new JLabel(org.openpnp.Translations.getString("Local.ff513d2eecb4515e"));
        ...
        chckbxMulti0.setToolTipText(org.openpnp.Translations.getString("Local.432bb4d11e970eb9"));
        chckbxMulti0.setSelected(true);
        panelPushPull.add(chckbxMulti0, "14, 12, 3, 1, center, default");

        chckbxPull0 = new JCheckBox("");
        chckbxPull0.setToolTipText(org.openpnp.Translations.getString("Local.3b10f6834e9403b4"));
        ...
        lblFeedSpeed0_1 = new JLabel(org.openpnp.Translations.getString("Local.3f4e07a087af71c2"));
        ...
        lblDelay0 = new JLabel(org.openpnp.Translations.getString("Local.fd9b6df3cdbc3d35"));
        ...
        textFieldDelay0.setToolTipText(org.openpnp.Translations.getString("Local.5633d84c12b1a1aa"));

        lblFeedMid1Location = new JLabel(org.openpnp.Translations.getString("Local.8835ec952f21d944"));
        ...
        chckbxPush1.setToolTipText(org.openpnp.Translations.getString("Local.1d6b04052edf9e6e"));
        chckbxPush1.setSelected(true);
        panelPushPull.add(chckbxPush1, "12, 16, center, default");

        chckbxMulti1 = new JCheckBox("");
        chckbxMulti1.setToolTipText(org.openpnp.Translations.getString("Local.55797191e24fab66"));
        chckbxMulti1.setSelected(true);
        panelPushPull.add(chckbxMulti1, "14, 16, 3, 1, center, default");

        chckbxPull1 = new JCheckBox("");
        chckbxPull1.setToolTipText(org.openpnp.Translations.getString("Local.6445defa4c2e9a20"));
        ...
        lblFeedSpeed1_2 = new JLabel(org.openpnp.Translations.getString("Local.3f4e07a087af71c2"));
        ...
        lblDelay1 = new JLabel(org.openpnp.Translations.getString("Local.fd9b6df3cdbc3d35"));
        ...
        textFieldDelay1.setToolTipText(org.openpnp.Translations.getString("Local.5633d84c12b1a1aa"));

        lblFeedMid2Location = new JLabel(org.openpnp.Translations.getString("Local.b982aa779474eb73"));
        ...
        chckbxPush2.setToolTipText(org.openpnp.Translations.getString("Local.9a96465419a7f6a1"));
        chckbxPush2.setSelected(true);
        panelPushPull.add(chckbxPush2, "12, 20, center, default");

        chckbxMulti2 = new JCheckBox("");
        chckbxMulti2.setToolTipText(org.openpnp.Translations.getString("Local.75a11fba5ab1c081"));
        chckbxMulti2.setSelected(true);
        panelPushPull.add(chckbxMulti2, "14, 20, 3, 1, center, default");

        chckbxPull2 = new JCheckBox("");
        chckbxPull2.setToolTipText(org.openpnp.Translations.getString("Local.70feb4d834fa9135"));
        ...
        lblFeedSpeed2_3 = new JLabel(org.openpnp.Translations.getString("Local.3f4e07a087af71c2"));
        ...
        lblDelay2 = new JLabel(org.openpnp.Translations.getString("Local.fd9b6df3cdbc3d35"));
        ...
        textFieldDelay2.setToolTipText(org.openpnp.Translations.getString("Local.5633d84c12b1a1aa"));

        lblFeedMid3Location = new JLabel(org.openpnp.Translations.getString("Local.958de8a516dc512f"));
        ...
        chckbxPush3.setToolTipText(org.openpnp.Translations.getString("Local.2fb26072cedf94c5"));
        chckbxPush3.setSelected(true);
        panelPushPull.add(chckbxPush3, "12, 24, center, default");

        chckbxMulti3 = new JCheckBox("");
        chckbxMulti3.setToolTipText(org.openpnp.Translations.getString("Local.7659d22de6adbf6e"));
        chckbxMulti3.setSelected(true);
        panelPushPull.add(chckbxMulti3, "14, 24, 3, 1, center, default");

        chckbxPull3 = new JCheckBox("");
        chckbxPull3.setToolTipText(org.openpnp.Translations.getString("Local.ca4427fdce4c1796"));
        ...
        lblFeedSpeed3_4 = new JLabel(org.openpnp.Translations.getString("Local.3f4e07a087af71c2"));
        ...
        lblDelay3 = new JLabel(org.openpnp.Translations.getString("Local.fd9b6df3cdbc3d35"));
        ...
        textFieldDelay3.setToolTipText(org.openpnp.Translations.getString("Local.5633d84c12b1a1aa"));

        JLabel lblFeedEndLocation = new JLabel(org.openpnp.Translations.getString("Local.a072be18eb512cbf"));
        ...
        chckbxPushEnd.setToolTipText(org.openpnp.Translations.getString("Local.32ad9be5d97304f7"));
        chckbxPushEnd.setSelected(true);
        panelPushPull.add(chckbxPushEnd, "12, 28, center, default");

        chckbxMultiEnd = new JCheckBox("");
        chckbxMultiEnd.setToolTipText(org.openpnp.Translations.getString("Local.384782a8dc7467d1"));
        ...
        lblDelay4 = new JLabel(org.openpnp.Translations.getString("Local.fd9b6df3cdbc3d35"));
        ...
        textFieldDelay4.setToolTipText(org.openpnp.Translations.getString("Local.5633d84c12b1a1aa"));
    ...
    private final Action actionRotationReset = new AbstractAction() {
        {
            ...
            putValue(NAME, org.openpnp.Translations.getString("Local.daee7606b339f3c3"));
            putValue(SHORT_DESCRIPTION, org.openpnp.Translations.getString("Local.5218f4c2d22d86c7"));
        }
