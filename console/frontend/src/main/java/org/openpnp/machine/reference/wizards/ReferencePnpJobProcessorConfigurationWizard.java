...
public class ReferencePnpJobProcessorConfigurationWizard extends AbstractConfigurationWizard {
    ...
    public ReferencePnpJobProcessorConfigurationWizard(ReferencePnpJobProcessor jobProcessor) {
        ...
        comboBoxJobOrder = new org.openpnp.gui.components.LocalizedComboBox<JobOrderHint>(JobOrderHint.values());
        ...
        comboBoxPlannerStrategy = new org.openpnp.gui.components.LocalizedComboBox<Strategy>(Strategy.values());
