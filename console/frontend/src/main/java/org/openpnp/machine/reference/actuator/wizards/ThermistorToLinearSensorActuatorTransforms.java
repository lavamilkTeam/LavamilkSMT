...
public class ThermistorToLinearSensorActuatorTransforms extends AbstractConfigurationWizard {
    ...
    private void createUi() {
        ...
        panel = new JPanel();
        panel.setBorder(new TitledBorder(null, org.openpnp.Translations.getString("Local.4fa94e55d82a558e"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        lblNewLabel_9 = new JLabel(org.openpnp.Translations.getString("Local.23f1295e09484b4b"));
        ...
        lblNewLabel_5 = new JLabel(org.openpnp.Translations.getString("Local.c96493a8bf3c2693"));
        ...
        lblNewLabel_6 = new JLabel(org.openpnp.Translations.getString("Local.c19d9dcd2152742c"));
        ...
        panel_2 = new JPanel();
        panel_2.setBorder(new TitledBorder(null, org.openpnp.Translations.getString("Local.b9a1f0c4403993f5"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        lblNewLabel_7 = new JLabel(org.openpnp.Translations.getString("Local.f102986b39effb31"));
        ...
        lblNewLabel_8 = new JLabel(org.openpnp.Translations.getString("Local.b1a1e8e3cf7c522e"));
