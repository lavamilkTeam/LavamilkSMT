...
public class ReferenceLinearTransformAxisConfigurationWizard extends AbstractAxisConfigurationWizard {
    ...
    public ReferenceLinearTransformAxisConfigurationWizard(AbstractMachine machine, AbstractTransformedAxis axis) {
        ...
        panelTransformation.setBorder(new TitledBorder(null, org.openpnp.Translations.getString("Local.9bfc781579d6fb8f"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        lblInput = new JLabel(org.openpnp.Translations.getString("Local.36ecb4f8669133ce"));
        panelTransformation.add(lblInput, "4, 2, center, default");

        lblFactor = new JLabel(org.openpnp.Translations.getString("Local.964a9c0606520b6e"));
        ...
        inputAxisX = new org.openpnp.gui.components.LocalizedComboBox(new AxesComboBoxModel(machine, LinearInputAxis.class, Axis.Type.X, true));
        ...
        inputAxisY = new org.openpnp.gui.components.LocalizedComboBox(new AxesComboBoxModel(machine, LinearInputAxis.class, Axis.Type.Y, true));
        ...
        inputAxisZ = new org.openpnp.gui.components.LocalizedComboBox(new AxesComboBoxModel(machine, LinearInputAxis.class, Axis.Type.Z, true));
        ...
        lblInputAxisRotation = new JLabel(org.openpnp.Translations.getString("Local.57b5e2fc1bba18bb"));
        panelTransformation.add(lblInputAxisRotation, "2, 16, right, default");

        inputAxisRotation = new org.openpnp.gui.components.LocalizedComboBox(new AxesComboBoxModel(machine, LinearInputAxis.class, Axis.Type.Rotation, true));
        ...
        lblOffset = new JLabel(org.openpnp.Translations.getString("Local.b1a1e8e3cf7c522e"));
        ...
        lblCompensation = new JLabel(org.openpnp.Translations.getString("Local.d2ab48e0ad82edcc"));
        lblCompensation.setToolTipText(org.openpnp.Translations.getString("Local.5d0722f7095d5ae2"));
