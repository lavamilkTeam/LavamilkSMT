...
public class MjpgCaptureCameraWizard extends AbstractConfigurationWizard {
    ...
    public MjpgCaptureCameraWizard(MjpgCaptureCamera camera) {
        ...
        lblIP = new JLabel(org.openpnp.Translations.getString("Local.719be19845a58f51"));
        ...
        lblTimeout = new JLabel(org.openpnp.Translations.getString("Local.0b46276a4184dde6"));
