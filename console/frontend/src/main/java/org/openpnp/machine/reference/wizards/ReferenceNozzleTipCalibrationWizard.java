...
public class ReferenceNozzleTipCalibrationWizard extends AbstractConfigurationWizard {
    ...
    public ReferenceNozzleTipCalibrationWizard(ReferenceNozzleTip nozzleTip) {
        ...
        recalibrationCb = new org.openpnp.gui.components.LocalizedComboBox(ReferenceNozzleTipCalibration.RecalibrationTrigger.values());
        ...
        backgroundCalibrationMethod = new org.openpnp.gui.components.LocalizedComboBox(BackgroundCalibrationMethod.values());
    ...
    public static ReferenceNozzle getUiCalibrationNozzle(ReferenceNozzleTip nozzleTip) throws Exception {
        ...
        if (nozzleTip.isUnloadedNozzleTipStandin()) {
            ...
            throw new Exception(org.openpnp.Translations.getString("Local.8841cc55f7060a3b"));
        }
        else {
            ...
            if (refNozzle == null) {
                throw new Exception(org.openpnp.Translations.getString("Local.66fa65a2d4bdc9fa"));
            }
            return refNozzle;
        }
    }
    ...
    public static void showBackgroundProblems(ReferenceNozzleTip nozzleTip, boolean noProblems) {
        UiUtils.messageBoxOnException(() -> {
            ...
            if (backgroundCalibrationImages == null) {
                throw new Exception(org.openpnp.Translations.format("Local.ea5ffd60f0115fd9", (nozzleTip.getName())));
            }
            int n = backgroundCalibrationImages.length;
            if (n == 0) {
                if (noProblems) {
                    throw new Exception(org.openpnp.Translations.format("Local.858c23c3699cfa6a", (nozzleTip.getName())));
                }
                else {
                    return;
                }
