...
public class ReferenceMappedAxisConfigurationWizard extends AbstractAxisConfigurationWizard {
    ...
    public ReferenceMappedAxisConfigurationWizard(AbstractMachine machine, ReferenceMappedAxis axis) {
        ...
        panelTransformation.setBorder(new TitledBorder(null, org.openpnp.Translations.getString("Local.2d3299c63acd48f3"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        lblFrom = new JLabel(org.openpnp.Translations.getString("Local.36ecb4f8669133ce"));
        panelTransformation.add(lblFrom, "4, 4, center, default");
        
        lblTo = new JLabel(org.openpnp.Translations.getString("Local.b2439bcb8dee14b6"));
        panelTransformation.add(lblTo, "8, 4, center, default");
        
        lblMapPointA = new JLabel(org.openpnp.Translations.getString("Local.a54e1412cfdcfbe1"));
        lblMapPointA.setToolTipText(org.openpnp.Translations.getString("Local.4d2ed4deb9bf9835"));
        ...
        lblMapPointB = new JLabel(org.openpnp.Translations.getString("Local.29d5ca5ae74b3bc6"));
