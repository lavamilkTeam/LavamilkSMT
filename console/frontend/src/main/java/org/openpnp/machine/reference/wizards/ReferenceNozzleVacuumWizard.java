...
public class ReferenceNozzleVacuumWizard extends AbstractConfigurationWizard {
    ...
    private void createUi() {
        ...
        vacuumComboBoxActuator = new org.openpnp.gui.components.LocalizedComboBox();
        ...
        blowOffComboBoxActuator = new org.openpnp.gui.components.LocalizedComboBox();
        ...
        vacuumSenseActuator = new org.openpnp.gui.components.LocalizedComboBox(new ActuatorsComboBoxModel(nozzle.getHead()));
