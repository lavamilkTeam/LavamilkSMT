...
public class CalibrationSolutions implements Solutions.Subject {
    ...
    private void perDownLookingCameraSolutions(Solutions solutions, ReferenceHead head,
        ...
        if (visionSolutions.isSolvedPrimaryXY(head)) {
                ...
                for (CoordinateAxis rawAxis : new CoordinateAxis[] {rawAxisX, rawAxisY}) {
                    if (rawAxis instanceof ReferenceControllerAxis) {
                        ...
                        solutions.add(new Solutions.Issue(
                                camera, 
                                org.openpnp.Translations.message("Local.0f53dd201588a1de", (axis.getName())), 
                                org.openpnp.Translations.message("Local.b9405531e97b8bc9", (axis.getName())), 
                            ...
                            public String getExtendedDescription() {
                                return org.openpnp.Translations.format("Local.53bb3e6561772d24", (camera.getName()), (axis.getName()), ((getState() == State.Solved ? 
                                                org.openpnp.Translations.getString("Local.3ef5d2ff5a4a6491")+axis.getBacklashOffset()+org.openpnp.Translations.getString("Local.e26c43a85b5fc0ac")+axis.getBacklashCompensationMethod().toString()+org.openpnp.Translations.getString("Local.3b25bdb286383d8c")+axis.getSneakUpOffset()+org.openpnp.Translations.getString("Local.0387b7e35cfd6758")+axis.getBacklashSpeedFactor()+org.openpnp.Translations.getString("Local.02cb87b1157bc6a9")+String.format("%.4f", getAxisCalibrationTolerance(camera, axis, true))+" mm</td></tr>"
                                                + "</table>" 
                                                : "")));
                            }
                            ...
                            public Solutions.Issue.CustomProperty[] getProperties() {
                                return new Solutions.Issue.CustomProperty[] {
                                        new Solutions.Issue.LengthProperty(
                                                org.openpnp.Translations.format("Local.359274c48f38f9d7"),
                                                org.openpnp.Translations.format("Local.b102eebba4b18947")) {
                                            @Override
                                            public Length get() {
                                                return tolerance;
                                            }
            ...
            if (visionSolutions.isSolvedPrimaryZ(head) // In addition to XY checked in the outer if()
                ...
                solutions.add(new Solutions.Issue(
                        camera, 
                        org.openpnp.Translations.message("Local.85eb6fff4af00a84", (camera.getName())), 
                        org.openpnp.Translations.message("Local.1bde244a83201324", (camera.getName())), 
                    ...
                    @Override 
                    public String getExtendedDescription() {
                        return org.openpnp.Translations.format("Local.7174275163fc38c1", (camera.getName()));
                    }
    ...
    private void perNozzleSolutions(Solutions solutions, ReferenceHead head, ReferenceCamera defaultCamera,
        ...
        if (visionSolutions.isSolvedPrimaryXY(head) 
            ...
            solutions.add(visionSolutions.new VisionFeatureIssue(
                    ...
                    org.openpnp.Translations.message("Local.17780a2ae6e14b97", (nozzle.getName())), 
                    org.openpnp.Translations.message("Local.848c1c796117c878", (nozzle.getName())), 
                    Solutions.Severity.Fundamental,
                ...
                @Override 
                public String getExtendedDescription() {
                    return org.openpnp.Translations.format("Local.04b7f523cdb186fa", (defaultCamera.getName()), (nozzle.getName()), ((getState() == State.Solved && !nozzle.getHeadOffsets().equals(oldNozzleOffsets) ? 
                                    org.openpnp.Translations.getString("Local.27ee9d003ac94254")+nozzle.getHeadOffsets()+"</td></tr>"
                                    + (oldNozzleOffsets == null ? "" : 
                                        org.openpnp.Translations.getString("Local.00bae3232a4fd3f9")+oldNozzleOffsets+org.openpnp.Translations.getString("Local.c8e53ae8c4dbea66")+nozzle.getHeadOffsets().subtract(oldNozzleOffsets)+"</td></tr>")
                                    + "</table>" 
                                    : "")));
                }
                ...
                public void setState(Solutions.State state) throws Exception {
                    if (state == State.Solved) {
                        ...
                        if (! (nozzle == defaultNozzle || nozzle.getHeadOffsets().isInitialized())) {
                            throw new Exception(org.openpnp.Translations.format("Local.3dc11772fbbc35e5", (nozzle.getName()), (nozzle.getName())));
                        }
                        final State oldState = getState();
                        UiUtils.submitUiMachineTask(
                                () -> {
    ...
    private void perUpLookingCameraSolutions(Solutions solutions, Camera defaultCamera,
        ...
        if (visionSolutions.isSolvedPrimaryXY((ReferenceHead) defaultNozzle.getHead())
            ...
            solutions.add(new Solutions.Issue(
                    camera, 
                    org.openpnp.Translations.message("Local.85eb6fff4af00a84", (camera.getName())), 
                    org.openpnp.Translations.message("Local.8fa5c46c8a2272ab", (camera.getName()), (defaultNozzle.getName())), 
                    Solutions.Severity.Suggestion,
                    "https://github.com/openpnp/openpnp/wiki/Calibration-Solutions#advanced-camera-calibration") {
                ...
                @Override 
                public String getExtendedDescription() {
                    return org.openpnp.Translations.format("Local.1941fc9db0bb29cb", (camera.getName()), (camera.getName()), (defaultNozzle.getName()), (camera.getName()), (defaultNozzle.getName()));
                }
    ...
    public void calibrateAxisBacklash(ReferenceHead head, ReferenceCamera camera,
        ...
        if (!(axis.isSoftLimitLowEnabled() && axis.isSoftLimitHighEnabled())) {
            throw new Exception(org.openpnp.Translations.format("Local.13d115dd6c7d7cb2", (axis.getName())));
        }
        if (! head.getCalibrationPrimaryFiducialLocation().isInitialized()) {
            throw new Exception(org.openpnp.Translations.format("Local.78623f7ee4da9a0e", (head.getName())));
        }
        if (head.getCalibrationPrimaryFiducialDiameter() == null 
                || ! head.getCalibrationPrimaryFiducialDiameter().isInitialized()) {
            throw new Exception(org.openpnp.Translations.format("Local.f71b20857fe51742", (head.getName())));
        }
            ...
            }
            {
                ...
                if (speed == minimumSpeed) {
                    if (effSpeed > Math.sqrt(speed)) {
                        throw new Exception(org.openpnp.Translations.format("Local.19160924e85bc906", ((int)(speed*100)), ((int)(effSpeed*100))));
                    }
                }
            }
        }
        ...
        if (Math.abs(absoluteErrMm) > toleranceMm*2.0) {
            ...
            throw new Exception(org.openpnp.Translations.format("Local.13c48ff2e7d66589", (lengthConverter.convertForward(
                    stepTest.subtract(absoluteErr))), (sysUnits.getShortName()), (lengthConverter.convertForward(stepTest)), (sysUnits.getShortName())));
        }
        ...
        if (sneakUpOffset > acceptableSneakUpOffsetMm) {
            ...
            throw new Exception(org.openpnp.Translations.format("Local.29a5a56a605a44dd", (axis.getName())));
        }
    ...
    private void advancedCameraCalibration(ReferenceCamera camera, HeadMountable movable, ReferenceHead head, Solutions.Issue issue)
        ...
        if (!Configuration.get().getMachine().isHomed()) {
            throw new Exception(org.openpnp.Translations.getString("Local.554eb4b8da63e62c"));
        }
        ...
        try {
            ...
            if (head != null) {
                ...
                if (nozzle.getNozzleTip() == null) {
                    throw new Exception(
                            org.openpnp.Translations.format("Local.12d1c88071abb45a", (nozzle.getName())));
                }
