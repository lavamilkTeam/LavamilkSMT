    ...
    public Action newAction = new AbstractAction() {
        {
            ...
            putValue(NAME, org.openpnp.Translations.getString("Local.b169c5adcf5edbe2"));
        ...
        public void actionPerformed(ActionEvent arg0) {
            ...
            try {
                ...
                MessageBoxes.errorBox(MainFrame.get(), org.openpnp.Translations.getString("Local.01f89b4daf1ca45e"), e);
            }
        }
    };
}
