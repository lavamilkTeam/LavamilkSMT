...
public class ReferenceHeapFeederConfigurationWizard
    ...
    public ReferenceHeapFeederConfigurationWizard(ReferenceHeapFeeder feeder) {
        ...
        heapPanel.setBorder(new TitledBorder(null, org.openpnp.Translations.getString("Local.bb30cbe2f9b87595"), TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        JLabel lblDropBox = new JLabel(org.openpnp.Translations.getString("Local.9753d4438475ac2d"));
        whateverPanel.add(lblDropBox, "2, 2, right, default");
        
        dropBoxCb = new org.openpnp.gui.components.LocalizedComboBox<DropBox>();
        dropBoxCb.setMaximumRowCount(4);
        whateverPanel.add(dropBoxCb, "4, 2, 2, 1");
        
        JPanel dropBoxPanel = new JPanel();
        dropBoxPanel.setBorder(new TitledBorder(null, org.openpnp.Translations.getString("Local.9753d4438475ac2d"), TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
        ...
        JLabel lblDropBoxCenterBottom = new JLabel(org.openpnp.Translations.getString("Local.dfb6f32c96860316"));
        ...
        lblDropLocation = new JLabel(org.openpnp.Translations.getString("Local.7085be364d88bb19"));
        ...
        lblPartsPipeline = new JLabel(org.openpnp.Translations.getString("Local.fd9f9f14e1a9b771"));
        ...
        lblDummyPart = new JLabel(org.openpnp.Translations.getString("Local.db23927a214ba6a5"));
        lblDummyPart.setToolTipText("");
        dropBoxPanel.add(lblDummyPart, "2, 10, right, default");
        
        cbDummyPartForUnknownParts = new org.openpnp.gui.components.LocalizedComboBox<Part>();
        ...
        cbDummyPartForUnknownParts.setToolTipText(org.openpnp.Translations.getString("Local.76b996bcd743bbe6"));
        ...
        JLabel lblHeapCenter = new JLabel(org.openpnp.Translations.getString("Local.467ec11ec52bde1a"));
        ...
        JLabel lblMove1 = new JLabel(org.openpnp.Translations.getString("Local.92ec5c3e53239227"));
        ...
        JLabel lblMove2 = new JLabel(org.openpnp.Translations.getString("Local.b72b84cc44a54d16"));
        ...
        JLabel lblMove3 = new JLabel(org.openpnp.Translations.getString("Local.3c8717462a342c2b"));
        ...
        lblDepth = new JLabel(org.openpnp.Translations.getString("Local.f1dbc33978a95b95"));
        ...
        lblLastFeedDepth = new JLabel(org.openpnp.Translations.getString("Local.6c65ab0a51c788d6"));
        ...
        JLabel lblFlipAttempts = new JLabel(org.openpnp.Translations.getString("Local.0ac574f30cf9f9d2"));
        whateverPanel.add(lblFlipAttempts, "2, 18, right, default");
        
        maxFlipAttemptsTf = new JTextField();
        maxFlipAttemptsTf.setToolTipText(org.openpnp.Translations.getString("Local.aa6793340c423950"));
        whateverPanel.add(maxFlipAttemptsTf, "4, 18, fill, default");
        maxFlipAttemptsTf.setColumns(10);
        
        lblVacuumDifference = new JLabel(org.openpnp.Translations.getString("Local.8d132fa59976eece"));
        ...
        partCb = new org.openpnp.gui.components.LocalizedComboBox<Part>();
        ...
        chckbxPokeForParts = new JCheckBox(org.openpnp.Translations.getString("Local.8e4ade42e99f8e6b"));
        chckbxPokeForParts.setToolTipText(org.openpnp.Translations.getString("Local.abb8df211fb0e890"));
        whateverPanel.add(chckbxPokeForParts, "8, 20");
        
        lblDetectionPipeline = new JLabel(org.openpnp.Translations.getString("Local.a6ea956b9afad67e"));
        ...
        lblTemplatePipeline = new JLabel(org.openpnp.Translations.getString("Local.e3062f71aa056f64"));
...
//        bind(UpdateStrategy.READ, move3Location, "location", move3LocButtons, "baseLocation");
    ...
    private Action actionPipelineEditFeeder = new AbstractAction(org.openpnp.Translations.getString("Local.464c4ffd019e1e96")) {
        @Override
    ...
    private Action actionPipelineResetFeeder = new AbstractAction(org.openpnp.Translations.getString("Local.daee7606b339f3c3")) {
        @Override
        public void actionPerformed(ActionEvent e) {
            UiUtils.messageBoxOnException(() -> {
    ...
    private Action actionPipelineEditTraining= new AbstractAction(org.openpnp.Translations.getString("Local.464c4ffd019e1e96")) {
        @Override
        public void actionPerformed(ActionEvent e) {
            UiUtils.messageBoxOnException(() -> {
    ...
    private Action actionPipelineResetTraining = new AbstractAction(org.openpnp.Translations.getString("Local.daee7606b339f3c3")) {
    ...
    private Action actionPipelineEditDropBox = new AbstractAction(org.openpnp.Translations.getString("Local.464c4ffd019e1e96")) {
        @Override
        public void actionPerformed(ActionEvent e) {
            UiUtils.messageBoxOnException(() -> {
                editPartsPipeline();
    ...
    private Action actionPipelineResetDropBox = new AbstractAction(org.openpnp.Translations.getString("Local.daee7606b339f3c3")) {
        @Override
        public void actionPerformed(ActionEvent e) {
            UiUtils.messageBoxOnException(() -> {
    ...
    private Action actionLastFeedDepthReset = new AbstractAction(org.openpnp.Translations.getString("Local.daee7606b339f3c3")) {
        @Override
        public void actionPerformed(ActionEvent e) {
            UiUtils.messageBoxOnException(() -> {
    ...
    private Action actionCleanDropbox = new AbstractAction(org.openpnp.Translations.getString("Local.cdc9a8c8512814dc")) {
        @Override
        public void actionPerformed(ActionEvent e) {
    ...
    private Action actionGetSamples = new AbstractAction(org.openpnp.Translations.getString("Local.2400fb2cd9fc3f79")) {
        @Override
        public void actionPerformed(ActionEvent e) {
            UiUtils.submitUiMachineTask(() -> {
                //Feeder feeder = getSelection();
    ...
    private Action newDropBoxAction = new AbstractAction(org.openpnp.Translations.getString("Local.18fdd549b2ed367a")) {
        @Override
        public void actionPerformed(ActionEvent e) {
            ...
            dropBoxNameTf.setText(org.openpnp.Translations.getString("Local.18fdd549b2ed367a"));
        }
    };
    
    private Action deleteDropBoxAction = new AbstractAction(org.openpnp.Translations.getString("Local.e2d0a54968ead24e")) {
        @Override
        public void actionPerformed(ActionEvent e) {
            DropBox box = (DropBox) dropBoxCb.getSelectedItem();
            if (ReferenceHeapFeeder.getDropBoxes().size() < 2) {
                MessageBoxes.errorBox(getTopLevelAncestor(), org.openpnp.Translations.getString("Local.54a0e8c17ebb21a1"), org.openpnp.Translations.getString("Local.98b705fbcf4ca7ed"));
            }
            ...
            if (isUsed) {
                MessageBoxes.errorBox(getTopLevelAncestor(), org.openpnp.Translations.getString("Local.54a0e8c17ebb21a1"), org.openpnp.Translations.getString("Local.6417c4627e8aa743"));
            }
