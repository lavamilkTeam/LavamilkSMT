...
public class Cycles {
    ...
    public static Location zProbe(Location l) throws Exception {
        ...
        try {
            ...
            throw new Exception(org.openpnp.Translations.format("Local.4cb155c092ea58e9", (Configuration.get().getMachine().getDefaultHead().getName()), (zProbe.getName()), (reading)), e);
        }
