...
public class FiniteStateMachine<State, Message> extends AbstractModelObject {
    ...
    public void send(Message message) throws Exception {
        while (message != null) {
            ...
            if (transitions == null) {
                throw new Exception(org.openpnp.Translations.format("Local.c034a5d7d703ecf9", (state)));
            }
            Transition transition = transitions.get(message);
            if (transition == null) {
                throw new Exception(org.openpnp.Translations.format("Local.b8b14f8586cceecb", (state), (message)));
            }
