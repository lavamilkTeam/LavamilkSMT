        ...
        public void interpretGcode(String input) throws Exception {
            ...
            for (char ch : input.toCharArray()) {
                ...
                if (ch == ' ') {
                    ...
                    if (insideComment) {
                        throw new Exception(org.openpnp.Translations.format("Local.6bd233e59cd705de", (col), (input)));
                    }
                    insideComment = true;
                    if (currentWord != null) {
                        currentWord.comment = "";
                    ...
                    if (!insideComment) {
                        throw new Exception(org.openpnp.Translations.format("Local.b4f8afb99bece71b", (col), (input)));
                    }
                    insideComment = false;
                }
                    ...
                    throw new Exception(org.openpnp.Translations.format("Local.d84d46ee0c633ade", (col), (ch), (input)));
                }
                else if (ch == '+') {
                        ...
                        if (controllerAxis.getDriver() == getDriver()) {
                            ...
                            if (letter.isEmpty() || letter.length() > 1) {
                                ...
                                if (axis.getName().equals("x") || axis.getName().equals("y") 
                                    ...
                                    throw new Exception(org.openpnp.Translations.format("Local.c62bde9b488b8f1e", (axis.getName())));
                                }
                            }
