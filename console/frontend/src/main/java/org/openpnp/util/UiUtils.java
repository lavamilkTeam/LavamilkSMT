    ...
    public static void confirmMoveToLocationAndAct(Component parentComponent, 
        ...
        messageBoxOnException(() -> {
            if (moveBeforeActionDescription == null) {
                ...
                if (allowWithoutMove) {
                    if (moveBeforeActionDescription != null) {
                        result = JOptionPane.showConfirmDialog(parentComponent,
                                org.openpnp.Translations.format("Local.0699d1e911f0c502", (moveBeforeActionDescription)),
                    ...
                    result = JOptionPane.showConfirmDialog(parentComponent,
                            org.openpnp.Translations.format("Local.aafe36bbcaf186b6", (moveBeforeActionDescription)),
                ...
                if (!allowWithoutMove) {
                    // Just say we can't. 
                    throw new Exception(org.openpnp.Translations.format("Local.57f1febc71f0be8a", (moveBeforeActionDescription)));
                }
                else {
                    // Ask the user if it is OK to proceed without moving. 
                    int result = JOptionPane.showConfirmDialog(parentComponent,
                            org.openpnp.Translations.format("Local.e23294c37b7e445d", (moveBeforeActionDescription)),
                                    null, JOptionPane.YES_NO_OPTION, JOptionPane.WARNING_MESSAGE);
                    if (result == JOptionPane.YES_OPTION) {
                        actionThrunnable.thrun();
                    }
        ...
        UiUtils.messageBoxOnException(() -> {
            ...
            try {
                ...
                try {
                    ...
                    throw new Exception(org.openpnp.Translations.format("Local.d838129fcdbfe4d1", (uri)), e1);
                }
            }
        });
    }
