...
public class OpenCvUtils {
    ...
    public static BufferedImage toBufferedImage(Mat m) {
        ...
        if (type == null) {
            throw new Error(String.format(org.openpnp.Translations.getString("Local.5bc177b4abf6bd70"),
        ...
        if (image != null) {
            if (colorSpace != null) {
                if ((image.channels() == 3) || (colorSpace == ColorSpace.Gray)) {
                    ...
                    throw new Exception(org.openpnp.Translations.format("Local.f848ef08c93edc34", (colorSpace)) );
                }
            }
        }
        return image;
    ...
    public static BufferedImage createFootprintTemplate(Camera camera, Footprint footprint, double rotation,
        ...
        if (shape == null) {
            throw new Exception(
                    org.openpnp.Translations.getString("Local.799425a68ac580b6"));
        }
        ...
        if (bounds.getWidth() == 0 || bounds.getHeight() == 0) {
            throw new Exception(
                    org.openpnp.Translations.getString("Local.e3cd2fdddf5a63f7"));
        }
