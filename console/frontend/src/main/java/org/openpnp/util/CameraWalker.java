...
public class CameraWalker {
    ...
    public RealMatrix estimateScaling(Length testStepLength, Point expectedPoint) throws Exception {
        ...
        for (int i=0; i<4; i++) {
            ...
            if (foundPoint == null) {
                throw new Exception(org.openpnp.Translations.getString("Local.b8934d46b74dfba8"));
            }
        ...
        if (estimatedMillimetersPerPixel <= 0) {
            throw new Exception(org.openpnp.Translations.getString("Local.1bbb59b1f2de7c6a"));
        }
    ...
    public Location walkToPoint(Location startingMachineLocation, Point startingImagePoint, 
        ...
        lastFoundPoint = null;
        if (!isReadyToWalk()) {
            throw new Exception(org.openpnp.Translations.getString("Local.0fc6528eb4a12c50"));
        }
        walkComplete = false;
        ...
        if (foundPoint == null) {
            throw new Exception(org.openpnp.Translations.getString("Local.dc0db59b4436d693"));
        }
    ...
    public boolean step() throws Exception {
        ...
        if (foundPoint == null) {
            ...
            throw new Exception(org.openpnp.Translations.getString("Local.1b6886b2bdbc298e"));
        }
