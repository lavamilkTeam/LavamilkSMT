        ...
        try {
            ...
            if (autoSetupMode == FindFeaturesMode.OcrOnly) {
                ...
                if (autoSetupMode != null) {
                    if (bestLine == null) {
                        throw new Exception(org.openpnp.Translations.getString("Local.b0ca1e0fba0d6536"));
                    }
                }
                ...
                if (bestLine != null) {
                    ...
                    if (autoSetupMode == FindFeaturesMode.FromPickLocationGetHoles
                        ...
                        if (holes.size() < 2) {
                            throw new Exception(org.openpnp.Translations.getString("Local.bdd04520216a552a"));
                        }
                        ...
                        if (calibratedHole1Location == null || calibratedHole2Location == null) {
                            if (autoSetupMode  == FindFeaturesMode.CalibrateHoles) {
                                throw new Exception(org.openpnp.Translations.getString("Local.96cc0ca55f13e98c"));
                            }
                        }
                        else {
                            if (calibratedHole1Location.unitVectorTo(calibratedHole2Location)
            ...
            throw new Exception(org.openpnp.Translations.format("Local.8bfef50924af1375", (resultsList)));
        }
        return this;
    }
}
