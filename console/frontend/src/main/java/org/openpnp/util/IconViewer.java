...
public class IconViewer extends JFrame {
    ...
    public IconViewer() {
        ...
        JLabel lblDirectory = new JLabel(org.openpnp.Translations.getString("Local.c8f84c3c5378b920"));
        ...
        JButton btnRefresh = new JButton(org.openpnp.Translations.getString("Local.0e91610117029a62"));
        panel.add(btnRefresh);
        
        chckbxGray = new JCheckBox(org.openpnp.Translations.getString("Local.bd6e1e33ae4206fa"));
    ...
    private class SwingAction extends AbstractAction {
        public SwingAction() {
            putValue(NAME, org.openpnp.Translations.getString("Local.bd6e1e33ae4206fa"));
            putValue(SHORT_DESCRIPTION, org.openpnp.Translations.getString("Local.97fdc19add6b056e"));
        }
